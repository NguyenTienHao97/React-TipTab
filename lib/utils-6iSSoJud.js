...
import Le, { useState as p, useRef as Y, useEffect as z, useCallback as A, useMemo as P, Fragment as st, forwardRef as At, useImperativeHandle as Lt } from "react";
...
import { u as V, C as go, E as xo, l as j, B as bo, I as Nt, V as Kt, M as po, D as fn, a as wo, b as _o, c as Si, d as gn, e as vo, f as We, g as Ke, h as hi, T as gt, i as xt, j as bt } from "./locales-BncC0k0S.js";
...
const Ho = li(
  ...
  ({ className: e, variant: t, size: i, asChild: n = !1, ...a }, o) => /* @__PURE__ */ r(
    n ? ui : "button",
    {
      className: D(Ho({ variant: t, size: i, className: e })),
      ref: o,
      ...a
    }
  )
...
const Do = li(
  ...
  {
    ref: a,
    className: D(Do({ variant: t, size: i, className: e })),
    ...n
  }
));
...
function ac({ editor: e, node: t, updateAttributes: i }) {
  const n = Y(null), a = e.isActive(De.name), { data: o, width: c, height: s } = t.attrs, [d, l] = p(null), [h, u] = p(!0), [f, g] = p(null), [x, b] = p(!1), [y, k] = p(100), v = A(
    (T) => {
      T && b(!0);
    },
    [b]
          ...
          /* @__PURE__ */ r(et, { children: /* @__PURE__ */ r(
            U,
            {
              ...
              onClick: async () => {
                if (o !== "") {
                  if (o) {
                    const y = u.current.querySelector("svg"), { width: k, height: v } = y.getBoundingClientRect(), _ = `mermaid-${In()}.svg`;
                    let C = ln(y.outerHTML);
                    if (f) {
                      const T = _i(C, _);
                      C = await f(T);
                    }
...
function Rc(e) {
  ...
  }, o = P(() => e.disabled ? [] : Ls(e.editor), [e.disabled, e.editor, t]);
...
function Vc({ editor: e, disabled: t, bubbleMenu: i }) {
  const n = e.extensionManager.extensions.map((o) => o.name), a = () => {
    ...
    return [
      ...
      (k = i == null ? void 0 : i.textConfig) != null && k.hidden ? null : /* @__PURE__ */ r(Os, { editor: e, disabled: t }, "text")
    ];
  };
...
function es({ editor: e, disabled: t }) {
  const { t: i } = V(), { isKeyboardVisible: n } = Qc(), a = P(
    () => [
      "Undo2",
      "Redo2",
      "Bold",
...
function Es(e) {
  var M, S, L;
  const { pluginKey: t = ya } = e, { t: i } = V(), [n, a] = p(null), [o, c] = p(-1), s = Y(null), d = Y(null), [l, h] = p(!1), u = e.editor.extensionManager.extensions.some((N) => N.name === "textAlign"), f = e.editor.extensionManager.extensions.some((N) => N.name === "indent"), g = e.editor.extensionManager.extensions.some((N) => N.name === "clear");
  z(() => {
...
function Os(e) {
  ...
  }, a = P(() => e.disabled || !(e != null && e.editor) ? [] : Ms(e.editor, t), [e.disabled, e.editor, i, t]);
...
function Ps({ editor: e, disabled: t }) {
  var f, g, x, b, y, k, v, _, C, T, I, O, M, S;
...
function js(e) {
  ...
  }, n = P(() => e.disabled ? [] : Ts(e.editor), [e.disabled, e.editor, t]);
  return /* @__PURE__ */ r(K, { children: /* @__PURE__ */ r(
    ce,
    {
      shouldShow: i,
...
function Ws(e) {
  ...
  }, n = P(() => e.disabled ? [] : Ss(e.editor), [e.editor, e.disabled, t]);
  return /* @__PURE__ */ r(K, { children: /* @__PURE__ */ r(
    ce,
    {
      shouldShow: i,
...
function cl({ editor: e, node: { attrs: t }, updateAttributes: i, extension: n }) {
  var f, g;
  const { isCopied: a, copyToClipboard: o } = ol(), c = P(() => {
    var x;
        ...
        v.commands.map((C, T) => /* @__PURE__ */ m(
          "button",
          {
            ...
            children: [
              ...
              C.iconName && /* @__PURE__ */ r(F, { name: C.iconName, className: "!richtext-mr-1 !richtext-text-lg" }),
              C.label
            ]
          },
          `command-${T}`
...
function $l(e) {
  ...
  const [t, i] = p({
    ...
    var Ni;
    const { src: S, alt: L, width: N, height: B, flipX: R, flipY: H } = (Ni = e == null ? void 0 : e.node) == null ? void 0 : Ni.attrs, E = Ct(N) ? `${N}px` : N, G = Ct(B) ? `${B}px` : B, J = [];
  ...
  const v = A(
    Se((S) => {
      if (S.preventDefault(), S.stopPropagation(), !c)
        return;
      const { x: L, w: N, dir: B } = d, R = (S.clientX - L) * (/l/.test(B) ? -1 : 1), H = hn(N + R, hi, t.width);
      e.updateAttributes({
        width: H,
        height: null
      });
...
function sd({ editor: e, ...t }) {
  ...
  return z(() => {
    ...
    if (!e)
      return;
    const b = e.extensionManager.extensions.find((k) => k.name === md.name);
    if (!b)
      return;
    const y = () => {
      if (!u)
  ...
  async function d(u) {
    ...
    if (ic(e.editor, "image")) {
      ...
      if (k && typeof k.upload == "function") {
        const v = [];
        for (const C of x) {
          const T = C.getAttribute("src"), I = Kd(T, "image/jpeg"), O = qd(I, "image.jpeg");
          v.push(O);
        }
...
function wh({ editor: e, node: t, updateAttributes: i, deleteNode: n, extension: a }) {
  var T;
  const o = Y(), c = Pt(), { hasTrigger: s, fileName: d, fileSize: l, fileExt: h, fileType: u, url: f, error: g } = t.attrs, [x, b] = p(!1), { t: y } = V(), k = (T = a == null ? void 0 : a.options) == null ? void 0 : T.upload, v = A(() => {
...
function _h(e) {
  ...
  const [t, i] = p({
    ...
    var H;
    const { src: M, alt: S, width: L, height: N } = (H = e == null ? void 0 : e.node) == null ? void 0 : H.attrs, B = Ct(L) ? `${L}px` : L, R = Ct(N) ? `${N}px` : N;
    return {
      src: M || void 0,
      alt: S || void 0,
      style: {
  ...
  function y(M, S) {
    ...
    const L = n.width, N = n.height, B = L / N;
  ...
  const k = A(
    Se((M) => {
      if (M.preventDefault(), M.stopPropagation(), !c)
        return;
      const { x: S, w: L, dir: N } = d, B = (M.clientX - S) * (/l/.test(N) ? -1 : 1), R = hn(L + B, hi, t.width);
      e.updateAttributes({
        width: R,
        height: null
      });
...
function Ch({ editor: e, node: t, updateAttributes: i, getPos: n, selected: a }) {
  const [o, c] = p({
    ...
    const { src: L, alt: N, width: B, height: R } = t == null ? void 0 : t.attrs, H = Li(B) ? `${B}px` : B, E = Li(R) ? `${R}px` : R;
    return {
      src: L || void 0,
      alt: N || void 0,
      style: {
  ...
  const T = A(
    Se((L) => {
      if (L.preventDefault(), L.stopPropagation(), !h)
        return;
      const { x: N, w: B, dir: R } = f, H = (L.clientX - N) * (/l/.test(R) ? -1 : 1), E = An(B + H, hi, o.width);
      i({
        width: E,
        height: null
      });
  ...
  const S = P(() => new ResizeObserver(() => _()), [_]);
