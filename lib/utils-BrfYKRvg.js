...
import { ChevronRight as er, Check as ai, Circle as tr, ChevronDown as Mt, ChevronUp as tn, HelpCircle as nn, Pencil as rn, Trash2 as an, X as ir, Plus as on, Bold as nr, LoaderCircle as rr, Italic as ar, Underline as or, Quote as cr, Strikethrough as sr, Minus as lr, Eraser as dr, PaintRoller as hr, Redo2 as ur, Undo2 as mr, Subscript as fr, Superscript as gr, Code as xr, CodeXml as br, Type as pr, IndentIncrease as wr, IndentDecrease as _r, List as vr, ListOrdered as yr, ListTodo as kr, Link as Cr, ImageUp as Nr, Video as Tr, Maximize as Ar, Minimize as Lr, Table as Sr, Sparkles as Mr, Unlink as Ir, BetweenHorizonalEnd as zr, BetweenHorizonalStart as Er, BetweenVerticalStart as Hr, BetweenVerticalEnd as Or, TableCellsMerge as Rr, TableCellsSplit as Pr, Trash as Br, Replace as Li, ChevronsUpDown as Dr, Heading1 as $r, Heading2 as Vr, Heading3 as Fr, Heading4 as jr, Heading5 as Ur, Heading6 as Wr, Columns2 as Si, Columns3 as Kr, Columns4 as qr, GripVertical as Gr, Copy as cn, Clipboard as Xr, PanelLeft as Zr, PanelRight as Yr, Frame as Jr, SmilePlus as Qr, SmilePlusIcon as ea, Sigma as ta, BookMarked as ia, ZoomIn as na, ZoomOut as ra, Settings as aa, Eye as oa, Paperclip as ca, CropIcon as sa, FlipVertical as la, FlipHorizontal as da, CopyCheck as ha, Clock3 as ua, Laugh as ma, LucideTableProperties as fa, LucideSheet as ga, LucideImage as xa, LucideFile as ba, LucideVideo as pa, LucideAudioLines as wa } from "lucide-react";
import { B as ce, N as ae, a as ue, m as ne, R as ge, n as oi, b as _a, u as va, E as ya, i as ka, D as Ca, d as Na, c as Ta, e as Aa, I as La, U as Sa, S as Ma, C as Ia, f as ct, g as za, h as Ea, F as Ha, H as Oa, T as Ra, j as Y, k as Pa, l as Ba, o as Da, O as $a, p as Va, q as Fa, r as ja, L as Ua, s as Wa, t as Ka, v as qa, w as Ga, x as Ct, P as Xa, y as Za, z as Ya, G as Ja, A as Qa, J as eo, K as to, M as io, Q as no, V as ro, W as sn, X as ln, Y as dn, Z as ci, _ as si, $ as ao, a0 as oo, a1 as co, a2 as so, a3 as lo, a4 as Mi } from "./tiptap-lrKgHTdQ.js";
import { al as ho, am as ee, an as li, ao as di, ap as uo, aq as hn, ar as mo, as as Se, e as It, d as Me, at as un, au as hi, av as fo, P as we, a as _e, a1 as Ue, a2 as Ke, aw as go, ax as Nt, ay as mn, ai as xo } from "./vendor-BeapTPDe.js";
import { bundledThemes as fn, bundledLanguages as gn, createHighlighter as bo } from "shiki";
import { u as V, C as po, E as wo, l as j, B as _o, I as Tt, V as qt, M as vo, D as xn, a as yo, b as ko, c as Ii, d as bn, e as Co, f as qe, g as Ge, h as ui, T as xt, i as bt, j as pt } from "./locales-CtbpiL3s.js";
...
import { HexColorPicker as Oo } from "react-colorful";
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ m(et, { children: [
      ...
      n && /* @__PURE__ */ r(Ee, { ...s, children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-items-center richtext-text-center richtext-max-w-24", children: [
        ...
        !!(c != null && c.length) && /* @__PURE__ */ r("span", { children: Ot(c) })
      ] }) })
    ] });
  }
), bi = je.forwardRef(
  ({ asChild: e, ...t }, i) => {
    ...
    return /* @__PURE__ */ m(et, { children: [
      ...
      /* @__PURE__ */ r(Ee, { children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-items-center richtext-text-center richtext-max-w-24", children: [
        ...
        /* @__PURE__ */ r("div", { className: "richtext-flex", children: !!((o = t == null ? void 0 : t.shortcutKeys) != null && o.length) && /* @__PURE__ */ r("span", { children: Ot(t == null ? void 0 : t.shortcutKeys) }) })
      ] }) })
    ] });
  }
);
...
Rt.displayName = G.Separator.displayName;
function yn({
  className: e,
  ...t
}) {
...
const Ko = $.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  Z.Separator,
  {
    ref: i,
    className: P("richtext--mx-1 richtext-my-1 richtext-h-px richtext-bg-muted", e),
...
Ko.displayName = Z.Separator.displayName;
...
const oc = 10, cc = 200, Hi = 15, Oi = { width: "100%", height: "100%", maxWidth: "100%" };
function sc({ editor: e, node: t, updateAttributes: i }) {
  ...
  E(() => {
    ...
    return (async () => {
      if (T || h || f || !x || !o)
        return;
      const R = await n.current(o);
      T || (R.setAttribute("width", "100%"), R.setAttribute("height", "100%"), R.setAttribute("display", "block"), l(R));
    })(), () => {
      T = !0;
    };
  }, [o, h, f, x]);
    ...
    wn,
    {
      ...
      children: /* @__PURE__ */ m(
        "div",
        {
          ...
          style: { ...Oi, overflow: "hidden" },
          children: [
            f && /* @__PURE__ */ r("div", { style: Oi, children: /* @__PURE__ */ r("p", { children: f.message || f }) }),
...
const He = oe.Root, Oe = oe.Trigger, mc = oe.Portal, Mn = $.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  oe.Overlay,
  {
    ref: i,
    className: P(
  ...
  addCommands() {
    return {
      setExcalidraw: (e) => ({ tr: t, commands: i, chain: n }) => {
        var a, o, c;
        return e = e || {}, e.data = e.data || Ri, ((c = (o = (a = t.selection) == null ? void 0 : a.node) == null ? void 0 : o.type) == null ? void 0 : c.name) == this.name ? i.updateAttributes(this.name, e) : n().insertContent({
          type: this.name,
          attrs: e
        }).run();
      }
          ...
          /* @__PURE__ */ r(it, { children: /* @__PURE__ */ r(
            U,
            {
              ...
              onClick: async () => {
                if (o !== "") {
                  if (o) {
                    const N = u.current.querySelector("svg"), { width: C, height: v } = N.getBoundingClientRect(), _ = `mermaid-${En()}.svg`;
...
function Rc({ item: e, disabled: t, editor: i }) {
  var a;
  const n = e.component;
...
function Uc({ editor: e, disabled: t, bubbleMenu: i }) {
  const n = e.extensionManager.extensions.map((o) => o.name), a = () => {
    ...
    return [
      ...
      n.includes("katex") && !((u = i == null ? void 0 : i.katexConfig) != null && u.hidden) ? /* @__PURE__ */ r(qo, { editor: e, disabled: t }, "katex") : null,
      ...
      (N = i == null ? void 0 : i.floatingMenuConfig) != null && N.hidden ? null : /* @__PURE__ */ r(Rs, { editor: e, disabled: t }, "content"),
  ...
  return E(() => () => {
    ...
    /* @__PURE__ */ m(re, { children: [
      /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-items-center richtext-justify-center", children: [
        /* @__PURE__ */ r(Oo, { color: t, onChange: i }),
        /* @__PURE__ */ r(
          te,
          {
...
function ts(e, t) {
  ...
  }, [s, e == null ? void 0 : e.disabled]), E(() => ((e == null ? void 0 : e.resetCSS) !== !1 && es(Kc, "react-tiptap-reset"), () => {
  ...
  }, []), s ? /* @__PURE__ */ r("div", { className: "reactjs-tiptap-editor", children: /* @__PURE__ */ m(Fo, { delayDuration: 0, disableHoverableContent: !0, children: [
...
function ns({ editor: e, disabled: t }) {
  const { t: i } = V(), { isKeyboardVisible: n, keyboardOffset: a } = is(), o = B(() => {
    const s = [...e.extensionManager.extensions].sort((l, h) => {
      const u = l.options.sort ?? -1, f = h.options.sort ?? -1;
      return u - f;
    });
    let d = [];
    for (const l of s) {
      const { button: h, divider: u = !1, spacer: f = !1, toolbar: g = !0 } = l.options;
      if (!h || !nc(h) || !g)
        continue;
      const x = h({
        editor: e,
      ...
      if (Array.isArray(x)) {
        const b = x.map((N, C) => ({
          button: N,
          divider: C === x.length - 1 ? u : !1,
          spacer: C === 0 ? f : !1
        }));
        d = [...d, ...b];
        continue;
      }
      d.push({ button: x, divider: u, spacer: f });
    }
    return d;
  }, [e, i]);
  return console.log("keyboardOffset", a), console.log("isKeyboardVisible", n), /* @__PURE__ */ r(
    "div",
    {
      style: {
      ...
      children: /* @__PURE__ */ r("div", { className: "richtext-flex richtext-gap-x-1", children: o.map((c, s) => {
        var l, h;
        const d = c.button.component;
        return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center", children: [
          (c == null ? void 0 : c.spacer) && /* @__PURE__ */ r(he, { orientation: "vertical", className: "!richtext-h-[16px] !richtext-mx-[10px]" }),
          /* @__PURE__ */ r(
            d,
            {
              ...c.button.componentProps,
              disabled: t || ((h = (l = c == null ? void 0 : c.button) == null ? void 0 : l.componentProps) == null ? void 0 : h.disabled)
            }
          ),
          (c == null ? void 0 : c.divider) && /* @__PURE__ */ r(he, { orientation: "vertical", className: "!richtext-h-auto !richtext-mx-2" })
        ] }, `toolbar-item-${s}`);
      }) })
    }
  );
...
function Ls(e) {
  ...
  return t.map((n, a) => ({
    ...
    componentProps: {
      tooltip: j.t(`editor.${n.replace("-", ".")}.tooltip`),
      icon: i[a],
      action: () => e.commands.updateVideo({ width: qt[n] }),
      isActive: () => e.isActive("video", { width: qt[n] })
    }
  }));
}
function Ss(e) {
...
function ji({ delta: e, types: t }) {
  return ({ state: i, dispatch: n, editor: a }) => {
    const { selection: o } = i;
    let { tr: c } = i;
    return c = c.setSelection(o), c = Os(c, e, t, a), c.docChanged ? (n && n(c), !0) : !1;
  };
}
function Rs(e) {
  var M, L, S;
  ...
  function I() {
    var y;
    if (o !== -1) {
      const D = (n == null ? void 0 : n.nodeSize) || 0, O = o + D, H = (n == null ? void 0 : n.type.name) === "paragraph" && ((y = n == null ? void 0 : n.content) == null ? void 0 : y.size) === 0, z = H ? o + 2 : O + 2;
      e.editor.chain().command(({ dispatch: q, tr: X, state: Re }) => q ? (H ? X.insertText("/", o, o + 1) : X.insert(
        O,
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-gap-0.5 [transition-property:top,_left] richtext-ease-in-out richtext-duration-200", children: [
        ...
        /* @__PURE__ */ m(ve, { open: l, onOpenChange: R, children: [
...
function Vs({ editor: e, disabled: t }) {
  var b, N, C, v, _, k, T, I, R, M, L, S, y, D, O, H, z, q;
      ...
      children: t ? /* @__PURE__ */ r(K, {}) : /* @__PURE__ */ m("div", { className: "richtext-min-w-32 richtext-flex richtext-flex-row richtext-h-full richtext-items-center richtext-leading-none richtext-gap-0.5 richtext-p-2 richtext-w-full richtext-bg-background richtext-rounded-lg richtext-shadow-sm !richtext-border richtext-border-border", children: [
        ...
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((M = (R = e == null ? void 0 : e.can()) == null ? void 0 : R.addRowAfter) != null && M.call(R))
          }
        ),
        /* @__PURE__ */ r(
          w,
        ...
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((H = (O = e == null ? void 0 : e.can()) == null ? void 0 : O.splitCell) != null && H.call(O))
          }
        ),
        /* @__PURE__ */ r(he, { orientation: "vertical", className: "!richtext-mx-1 !richtext-my-2 !richtext-h-[16px]" }),
        /* @__PURE__ */ r(
        ...
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((q = (z = e == null ? void 0 : e.can()) == null ? void 0 : z.deleteTable) != null && q.call(z))
          }
        )
      ] })
    }
...
function js({ editor: e, disabled: t }) {
  ...
  return /* @__PURE__ */ r(K, { children: /* @__PURE__ */ r(
    ce,
    {
      ...
      children: t ? /* @__PURE__ */ r(K, {}) : /* @__PURE__ */ r(K, { children: i ? /* @__PURE__ */ r(Wn, { onSetLink: c, editor: e }) : /* @__PURE__ */ r(
        Fs,
        {
          editor: e,
          onClear: s,
...
function Ui({
  ...
  return ct(e, (c) => c.type.name === t).forEach((c) => {
    ...
    for (const g of f) {
      for (const x of g) {
        const b = s + x.content.length, N = Ke.inline(s, b, {
          style: `color: ${x.color}`
        });
        a.push(N), s = b;
      }
      ...
      class o {
        ...
        async checkUndecoratedBlocks() {
          ...
          if ((await Promise.all(
            s.flatMap((h) => [
              Kn(h.node.attrs.theme),
              qn(h.node.attrs.language)
            ])
          )).includes(!0)) {
...
function _l(e) {
  ...
  return /* @__PURE__ */ m(et, { children: [
    ...
    i && /* @__PURE__ */ r(Ee, { ...a, children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-items-center richtext-text-center richtext-max-w-24", children: [
      ...
      !!((l = e == null ? void 0 : e.shortcutKeys) != null && l.length) && /* @__PURE__ */ r("span", { children: Ot(e == null ? void 0 : e.shortcutKeys) })
    ] }) })
  ] });
}
const vl = ["undo", "redo"], xu = qa.extend({
  addOptions() {
    var e;
    return {
      ...(e = this.parent) == null ? void 0 : e.call(this),
        ...
        props: {
          decorations(t) {
            return t.selection.empty || e.isFocused === !0 ? null : Ue.create(t.doc, [
              Ke.inline(t.selection.from, t.selection.to, {
                class: "selection"
              })
            ]);
          }
    ...
    /* @__PURE__ */ r(be, { className: "w-full", children: (i = e == null ? void 0 : e.items) == null ? void 0 : i.map((n, a) => /* @__PURE__ */ m(
      ze,
      {
        ...
        children: [
          ...
          !!(n != null && n.shortcutKeys) && /* @__PURE__ */ r("span", { className: "richtext-ml-auto richtext-text-xs richtext-tracking-widest richtext-opacity-60", children: Ot(n.shortcutKeys) })
        ]
      },
      `more-mark-${a}`
    )) })
...
function Rl(e) {
  return ({ state: t, dispatch: i }) => {
    const { selection: n } = t;
    let { tr: a } = t;
    return a = a.setSelection(n), a = Ol(a, e), a.docChanged ? (i && i(a), !0) : !1;
  };
}
const yu = Y.create({
  name: "lineHeight",
...
function Fl(e) {
  ...
  const [t, i] = p({
    ...
    h: 0,
    dir: ""
  }), { align: h, inline: u } = (R = e == null ? void 0 : e.node) == null ? void 0 : R.attrs, f = B(() => {
    var xe;
    const { src: L, alt: S, width: y, height: D, flipX: O, flipY: H } = (xe = e == null ? void 0 : e.node) == null ? void 0 : xe.attrs, z = Nt(y) ? `${y}px` : y, q = Nt(D) ? `${D}px` : D, X = [];
    O && X.push("rotateX(180deg)"), H && X.push("rotateY(180deg)");
    const Re = X.join(" ");
    return {
      src: L || void 0,
      alt: S || void 0,
  ...
  function C(L, S) {
    ...
    const y = n.width, D = n.height, O = y / D;
    let H = Number(e.node.attrs.width), z = Number(e.node.attrs.height);
    const q = t.width;
    H && !z ? (H = H > q ? q : H, z = Math.round(H / O)) : z && !H ? (H = Math.round(z * O), H = H > q ? q : H) : !H && !z ? (H = y > q ? q : y, z = Math.round(H / O)) : H = H > q ? q : H, Xe(() => {
      s(!0), l({
        x: L.clientX,
        y: L.clientY,
        w: H,
  ...
  const v = A(
    Se((L) => {
      if (L.preventDefault(), L.stopPropagation(), !c)
        return;
      const { x: S, w: y, dir: D } = d, O = (L.clientX - S) * (/l/.test(D) ? -1 : 1), H = mn(y + O, ui, t.width);
      e.updateAttributes({
        width: H,
        height: null
      });
...
function jl({ editor: e, imageInline: t, onClose: i }) {
  ...
  function b(_, k) {
    const T = document.createElement("canvas"), I = _.naturalWidth / _.width, R = _.naturalHeight / _.height;
    T.width = k.width * I, T.height = k.height * R;
  ...
  async function N() {
    ...
    try {
      ...
      let R = "";
      I.upload ? R = await I.upload(T) : R = URL.createObjectURL(T), e.chain().focus().setImageInline({ src: R, inline: t }).run(), o(!1), g({
        src: "",
        file: null
      }), i();
    } catch (T) {
  ...
  const v = async (_) => {
    var R;
    const k = (R = _ == null ? void 0 : _.target) == null ? void 0 : R.files;
    if (!e || e.isDestroyed || k.length === 0)
      return;
    const T = k[0], I = await zc(T);
    o(!0), g({
      src: I.src,
      file: T
    });
      ...
      apply(e, t) {
        ...
        if (i != null && i.add)
          for (const { id: n, pos: a, src: o } of i.add) {
            const c = Kl(o), s = Ke.widget(a, c, { id: n });
            t = t.add(e.doc, [s]);
          }
...
const rd = Y.create({
  ...
  addCommands() {
    return {
      setTableCellBackground: (e) => qi(e, this.options),
      unsetTableCellBackground: () => qi("", this.options)
    };
  }
...
function ud(e, t, i) {
  ...
  for (let s = 0; s < o.length; s += 1) {
    const d = o[s];
    n.push(Ke.inline(d.from, d.to, { class: i }));
  }
  return {
          ...
          apply(t) {
            ...
            if (n || a) {
              ...
              if (e.storage.results = h, e.storage.currentIndex > h.length - 1 && (e.storage.currentIndex = 0), window.dispatchEvent(Pe), t.getMeta("directDecoration")) {
                ...
                l.push(Ke.inline(u, f, g));
              } else
                h.length && (l[0] = Ke.inline(h[0].from, h[0].to, {
                  class: c
                }));
  ...
  async function d(u) {
    ...
    if (ac(e.editor, "image")) {
      ...
      if (C && typeof C.upload == "function") {
        const v = [];
        for (const k of x) {
          const T = k.getAttribute("src"), I = Gd(T, "image/jpeg"), R = Xd(I, "image.jpeg");
          v.push(R);
        }
...
const _h = "_wrap_gpqtf_1", Kt = {
  wrap: _h
};
function vh({ editor: e, node: t, updateAttributes: i, deleteNode: n, extension: a }) {
  var T;
  const o = J(), c = Bt(), { hasTrigger: s, fileName: d, fileSize: l, fileExt: h, fileType: u, url: f, error: g } = t.attrs, [x, b] = p(!1), { t: N } = V(), C = (T = a == null ? void 0 : a.options) == null ? void 0 : T.upload, v = A(() => {
    !c || f || c && o.current.click();
  }, [c, f]), _ = A(
    async (I) => {
      const R = I.target.files && I.target.files[0];
      if (!R)
        return;
      const M = {
        fileName: Lc(R.name),
  ...
  const k = A(() => n(), [e]);
  return c && !f ? /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ m("div", { className: ee(Kt.wrap, "render-wrapper"), children: [
  ...
  ] }) }) : f ? /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ m("div", { className: ee(Kt.wrap, "render-wrapper"), onClick: v, children: [
  ...
  ] }) }) : g !== "null" ? /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ r("div", { className: ee(Kt.wrap, "render-wrapper"), onClick: v, children: /* @__PURE__ */ r("p", { children: g }) }) }) : /* @__PURE__ */ r(K, {});
}
const Eu = ue.create({
  name: "attachment",
  content: "",
...
function yh(e) {
  ...
  const [t, i] = p({
    ...
    var H;
    const { src: M, alt: L, width: S, height: y } = (H = e == null ? void 0 : e.node) == null ? void 0 : H.attrs, D = Nt(S) ? `${S}px` : S, O = Nt(y) ? `${y}px` : y;
    return {
      src: M || void 0,
      alt: L || void 0,
      style: {
  ...
  }, [(R = e == null ? void 0 : e.node) == null ? void 0 : R.attrs]), f = B(() => {
    const {
      style: { width: M }
    } = u;
  ...
  function N(M, L) {
    ...
    let O = Number(e.node.attrs.width), H = Number(e.node.attrs.height);
    const z = t.width;
    O && !H ? (O = O > z ? z : O, H = Math.round(O / D)) : H && !O ? (O = Math.round(H * D), O = O > z ? z : O) : !O && !H ? (O = S > z ? z : S, H = Math.round(O / D)) : O = O > z ? z : O, Xe(() => {
      s(!0), l({
        x: M.clientX,
        y: M.clientY,
        w: O,
  ...
  const C = A(
    Se((M) => {
      if (M.preventDefault(), M.stopPropagation(), !c)
        return;
      const { x: L, w: S, dir: y } = d, D = (M.clientX - L) * (/l/.test(y) ? -1 : 1), O = mn(S + D, ui, t.width);
      e.updateAttributes({
        width: O,
        height: null
      });
  ...
  return E(() => (T.observe(e.editor.view.dom), () => {
    T.disconnect();
...
function Th({ editor: e, node: t, updateAttributes: i, getPos: n, selected: a }) {
  const [o, c] = p({
    ...
    const { src: S, alt: y, width: D, height: O } = t == null ? void 0 : t.attrs, H = Mi(D) ? `${D}px` : D, z = Mi(O) ? `${O}px` : O;
    return {
      src: S || void 0,
      alt: y || void 0,
      style: {
  ...
  function k(S, y) {
    ...
    const D = s.width, O = s.height, H = D / O;
    let z = Number(t.attrs.width), q = Number(t.attrs.height);
    const X = o.width;
    z && !q ? (z = z > X ? X : z, q = Math.round(z / H)) : q && !z ? (z = Math.round(q * H), z = z > X ? X : z) : !z && !q ? (z = D > X ? X : D, q = Math.round(z / H)) : z = z > X ? X : z, Xe(() => {
      u(!0), g({
        x: S.clientX,
        y: S.clientY,
        w: z,
  ...
  const T = A(
    Se((S) => {
      if (S.preventDefault(), S.stopPropagation(), !h)
        return;
      const { x: y, w: D, dir: O } = f, H = (S.clientX - y) * (/l/.test(O) ? -1 : 1), z = Sn(D + H, ui, o.width);
      i({
        width: z,
        height: null
      });
