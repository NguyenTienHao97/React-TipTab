...
import { B as ce, N as ae, a as ue, m as ne, R as ge, n as oi, b as _a, u as va, E as ya, i as ka, D as Ca, d as Na, c as Ta, e as Aa, I as La, U as Sa, S as Ma, C as Ia, f as ct, g as za, h as Ea, F as Ha, H as Ra, T as Oa, j as Y, k as Pa, l as Ba, o as Da, O as $a, p as Va, q as Fa, r as ja, L as Ua, s as Wa, t as qa, v as Ka, w as Ga, x as Ct, P as Xa, y as Za, z as Ya, G as Ja, A as Qa, J as eo, K as to, M as io, Q as no, V as ro, W as sn, X as ln, Y as dn, Z as ci, _ as si, $ as ao, a0 as oo, a1 as co, a2 as so, a3 as lo, a4 as Mi } from "./tiptap-lrKgHTdQ.js";
import { al as ho, am as ee, an as li, ao as di, ap as uo, aq as hn, ar as mo, as as Se, e as It, d as Me, at as un, au as hi, av as fo, P as we, a as _e, a1 as Ue, a2 as qe, aw as go, ax as Nt, ay as mn, ai as xo } from "./vendor-BeapTPDe.js";
import { bundledThemes as fn, bundledLanguages as gn, createHighlighter as bo } from "shiki";
import { u as V, C as po, E as wo, l as j, B as _o, I as Tt, V as Kt, M as vo, D as xn, a as yo, b as ko, c as Ii, d as bn, e as Co, f as Ke, g as Ge, h as ui, T as xt, i as bt, j as pt } from "./locales-BTQOUnAl.js";
...
function Vs({ editor: e, disabled: t }) {
  var b, N, C, v, _, k, T, I, O, M, L, S, y, D, R, H, z, K;
  ...
  async function d(u) {
    ...
    if (ac(e.editor, "image")) {
      ...
      if (C && typeof C.upload == "function") {
        const v = [];
        for (const k of x) {
          const T = k.getAttribute("src"), I = Gd(T, "image/jpeg"), O = Xd(I, "image.jpeg");
          v.push(O);
        }
