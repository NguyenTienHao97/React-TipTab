...
import { B as ce, N as ae, a as he, m as ne, R as ge, n as ai, b as ba, u as pa, E as wa, i as _a, D as va, d as ya, c as ka, e as Ca, I as Na, U as Ta, S as Aa, C as La, f as at, g as Sa, h as Ma, F as Ia, H as za, T as Ea, j as Z, k as Ha, l as Ra, o as Oa, O as Pa, p as Da, q as Ba, r as $a, L as Va, s as Fa, t as ja, v as Ua, w as Wa, x as kt, P as Ka, y as qa, z as Ga, G as Xa, A as Za, J as Ya, K as Ja, M as Qa, Q as eo, V as to, W as on, X as cn, Y as sn, Z as oi, _ as ci, $ as io, a0 as no, a1 as ro, a2 as ao, a3 as oo, a4 as Li } from "./tiptap-DnSmxR8Y.js";
import { al as co, am as ee, an as si, ao as li, ap as so, aq as ln, ar as lo, as as Se, e as Mt, d as Me, at as dn, au as ho, P as pe, a as we, a1 as Fe, a2 as Ue, av as di, aw as uo, ax as Ct, ay as hn, ai as mo } from "./vendor-DmdcCQdP.js";
import { bundledThemes as un, bundledLanguages as mn, createHighlighter as fo } from "shiki";
import { u as V, C as go, E as xo, l as j, B as bo, I as Nt, V as Kt, M as po, D as fn, a as wo, b as _o, c as Si, d as gn, e as vo, f as We, g as Ke, h as hi, T as gt, i as xt, j as bt } from "./locales-CFYxm3Ai.js";
...
function ac({ editor: e, node: t, updateAttributes: i }) {
  const n = Y(null), a = e.isActive(De.name), { data: o, width: c, height: s } = t.attrs, [d, l] = p(null), [h, u] = p(!0), [f, g] = p(null), [x, b] = p(!1), [C, T] = p(100), v = A(
    (N) => {
      N && b(!0);
    },
    [b]
...
function Jc(e, t) {
  const { content: i, extensions: n, useEditorOptions: a = {} } = e, o = D(() => {
    ...
    content: i,
    onUpdate: ({ editor: l }) => {
      "virtualKeyboard" in navigator && navigator != null && navigator.virtualKeyboard && (navigator == null || navigator.virtualKeyboard.hide()), c && c(l);
    },
    ...a
  });
  Lt(t, () => ({
...
function es({ editor: e, disabled: t }) {
  const { t: i } = V(), { isKeyboardVisible: n } = Qc(), a = D(() => ["Undo2", "Redo2", "Bold", "Italic", "Type", "KatexIcon", "List", "ListOrdered", "Code2", "Attachment", "ImageUp", "Video"], []), o = D(() => {
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r("div", { className: "richtext-flex richtext-gap-x-1", children: c.map((s, d) => {
        var l, h, u;
        if (a.includes((l = s.button.componentProps) == null ? void 0 : l.icon)) {
          const f = s.button.component;
        ...
        return /* @__PURE__ */ r(Le.Fragment, {}, `toolbar-item-${d}`);
      }) })
    }
  );
}
