...
import { u as V, C as po, E as wo, l as j, B as _o, I as Tt, V as Kt, M as vo, D as xn, a as yo, b as ko, c as Ii, d as bn, e as Co, f as Ke, g as Ge, h as ui, T as xt, i as bt, j as pt } from "./locales-CPELmxzX.js";
...
const ve = G.Root, ye = G.Trigger, Ei = G.Portal, zi = G.Sub, Zt = $.forwardRef(({ className: e, inset: t, children: i, ...n }, a) => /* @__PURE__ */ m(
  G.SubTrigger,
  {
    ref: a,
    className: P(
...
Ee.displayName = G.CheckboxItem.displayName;
...
const Fo = ht.Provider, et = ht.Root, tt = ht.Trigger, ze = $.forwardRef(({ className: e, sideOffset: t = 4, ...i }, n) => /* @__PURE__ */ r(
  ht.Content,
  {
    ref: n,
    sideOffset: t,
          ...
          /* @__PURE__ */ r(it, { children: /* @__PURE__ */ r(
            U,
            {
              ...
              onClick: async () => {
                if (o !== "") {
                  if (o) {
                    const N = u.current.querySelector("svg"), { width: k, height: v } = N.getBoundingClientRect(), _ = `mermaid-${zn()}.svg`;
...
function ts(e, t) {
  ...
  }, []), s ? /* @__PURE__ */ r("div", { style: { background: "#E1ECFE" }, className: "reactjs-tiptap-editor", children: /* @__PURE__ */ r(Fo, { delayDuration: 0, disableHoverableContent: !0, children: /* @__PURE__ */ m("div", { className: "richtext-overflow-hidden", children: [
...
const Yh = Lt(ts), is = 50;
function ns({ editor: e, disabled: t }) {
  const { t: i } = V(), [n, a] = p(!1), [o, c] = p(0), s = A(() => {
    var h;
  ...
  z(() => {
    var l, h;
    return (l = window.visualViewport) == null || l.addEventListener("resize", s), (h = window.visualViewport) == null || h.addEventListener("scroll", s), window == null || window.addEventListener("touchmove", s), s(), () => {
      var u, f;
      (u = window.visualViewport) == null || u.removeEventListener("resize", s), (f = window.visualViewport) == null || f.removeEventListener("scroll", s), window == null || window.removeEventListener("touchmove", s);
    };
  }, [s]);
  const d = B(() => {
...
function Os(e) {
  var M, L, S;
  const { pluginKey: t = Na } = e, { t: i } = V(), [n, a] = p(null), [o, c] = p(-1), s = J(null), d = J(null), [l, h] = p(!1), u = e.editor.extensionManager.extensions.some((C) => C.name === "textAlign"), f = e.editor.extensionManager.extensions.some((C) => C.name === "indent"), g = e.editor.extensionManager.extensions.some((C) => C.name === "clear");
  z(() => {
  ...
  function I() {
    var C;
    if (o !== -1) {
      const D = (n == null ? void 0 : n.nodeSize) || 0, R = o + D, H = (n == null ? void 0 : n.type.name) === "paragraph" && ((C = n == null ? void 0 : n.content) == null ? void 0 : C.size) === 0, E = H ? o + 2 : R + 2;
        ...
        /* @__PURE__ */ m(ve, { open: l, onOpenChange: O, children: [
          ...
          /* @__PURE__ */ m(be, { className: "richtext-w-48", align: "start", side: "bottom", sideOffset: 0, children: [
            ...
            u ? /* @__PURE__ */ m(zi, { children: [
              ...
              /* @__PURE__ */ r(Ei, { children: /* @__PURE__ */ m(Yt, { children: [
...
function Vs({ editor: e, disabled: t }) {
  var b, N, k, v, _, y, T, I, O, M, L, S, C, D, R, H, E, K;
      ...
      children: t ? /* @__PURE__ */ r(q, {}) : /* @__PURE__ */ m("div", { className: "richtext-min-w-32 richtext-flex richtext-flex-row richtext-h-full richtext-items-center richtext-leading-none richtext-gap-0.5 richtext-p-2 richtext-w-full richtext-bg-background richtext-rounded-lg richtext-shadow-sm !richtext-border richtext-border-border", children: [
        ...
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((K = (E = e == null ? void 0 : e.can()) == null ? void 0 : E.deleteTable) != null && K.call(E))
          }
        )
      ] })
    }
...
function Fl(e) {
  ...
  const [t, i] = p({
    ...
    var xe;
    const { src: L, alt: S, width: C, height: D, flipX: R, flipY: H } = (xe = e == null ? void 0 : e.node) == null ? void 0 : xe.attrs, E = Nt(C) ? `${C}px` : C, K = Nt(D) ? `${D}px` : D, X = [];
  ...
  function k(L, S) {
    ...
    const K = t.width;
    H && !E ? (H = H > K ? K : H, E = Math.round(H / R)) : E && !H ? (H = Math.round(E * R), H = H > K ? K : H) : !H && !E ? (H = C > K ? K : C, E = Math.round(H / R)) : H = H > K ? K : H, Xe(() => {
      s(!0), l({
        x: L.clientX,
        y: L.clientY,
        w: H,
  ...
  const v = A(
    Se((L) => {
      if (L.preventDefault(), L.stopPropagation(), !c)
        return;
      const { x: S, w: C, dir: D } = d, R = (L.clientX - S) * (/l/.test(D) ? -1 : 1), H = mn(C + R, ui, t.width);
      e.updateAttributes({
        width: H,
        height: null
      });
...
function vh({ editor: e, node: t, updateAttributes: i, deleteNode: n, extension: a }) {
  var T;
  const o = J(), c = Bt(), { hasTrigger: s, fileName: d, fileSize: l, fileExt: h, fileType: u, url: f, error: g } = t.attrs, [x, b] = p(!1), { t: N } = V(), k = (T = a == null ? void 0 : a.options) == null ? void 0 : T.upload, v = A(() => {
...
function yh(e) {
  ...
  const [t, i] = p({
    ...
    var H;
    const { src: M, alt: L, width: S, height: C } = (H = e == null ? void 0 : e.node) == null ? void 0 : H.attrs, D = Nt(S) ? `${S}px` : S, R = Nt(C) ? `${C}px` : C;
    return {
      src: M || void 0,
      alt: L || void 0,
      style: {
...
function Th({ editor: e, node: t, updateAttributes: i, getPos: n, selected: a }) {
  const [o, c] = p({
    ...
    const { src: S, alt: C, width: D, height: R } = t == null ? void 0 : t.attrs, H = Mi(D) ? `${D}px` : D, E = Mi(R) ? `${R}px` : R;
    return {
      src: S || void 0,
      alt: C || void 0,
      style: {
  ...
  function y(S, C) {
    ...
    let E = Number(t.attrs.width), K = Number(t.attrs.height);
    const X = o.width;
    E && !K ? (E = E > X ? X : E, K = Math.round(E / H)) : K && !E ? (E = Math.round(K * H), E = E > X ? X : E) : !E && !K ? (E = D > X ? X : D, K = Math.round(E / H)) : E = E > X ? X : E, Xe(() => {
      u(!0), g({
        x: S.clientX,
        y: S.clientY,
        w: E,
  ...
  const T = A(
    Se((S) => {
      if (S.preventDefault(), S.stopPropagation(), !h)
        return;
      const { x: C, w: D, dir: R } = f, H = (S.clientX - C) * (/l/.test(R) ? -1 : 1), E = Sn(D + H, ui, o.width);
      i({
        width: E,
        height: null
      });
