...
import je, { useState as p, useRef as J, useEffect as H, useCallback as A, useMemo as B, Fragment as dt, forwardRef as Lt, useImperativeHandle as St } from "react";
import "@radix-ui/react-toast";
import { ChevronRight as er, Check as ai, Circle as tr, ChevronDown as Mt, ChevronUp as tn, HelpCircle as nn, Pencil as rn, Trash2 as an, X as ir, Plus as on, Bold as nr, LoaderCircle as rr, Italic as ar, Underline as or, Quote as cr, Strikethrough as sr, Minus as lr, Eraser as dr, PaintRoller as hr, Redo2 as ur, Undo2 as mr, Subscript as fr, Superscript as gr, Code as xr, CodeXml as br, Type as pr, IndentIncrease as wr, IndentDecrease as _r, List as vr, ListOrdered as yr, ListTodo as kr, Link as Cr, ImageUp as Nr, Video as Tr, Maximize as Ar, Minimize as Lr, Table as Sr, Sparkles as Mr, Unlink as Ir, BetweenHorizonalEnd as zr, BetweenHorizonalStart as Hr, BetweenVerticalStart as Er, BetweenVerticalEnd as Rr, TableCellsMerge as Or, TableCellsSplit as Pr, Trash as Br, Replace as Li, ChevronsUpDown as Dr, Heading1 as $r, Heading2 as Fr, Heading3 as Vr, Heading4 as jr, Heading5 as Ur, Heading6 as Wr, Columns2 as Si, Columns3 as qr, Columns4 as Kr, GripVertical as Gr, Copy as cn, Clipboard as Xr, PanelLeft as Yr, PanelRight as Zr, Frame as Jr, SmilePlus as Qr, SmilePlusIcon as ea, Sigma as ta, BookMarked as ia, ZoomIn as na, ZoomOut as ra, Settings as aa, Eye as oa, Paperclip as ca, CropIcon as sa, FlipVertical as la, FlipHorizontal as da, CopyCheck as ha, Clock3 as ua, Laugh as ma, LucideTableProperties as fa, LucideSheet as ga, LucideImage as xa, LucideFile as ba, LucideVideo as pa, LucideAudioLines as wa } from "lucide-react";
import { B as ce, N as ae, a as ue, m as ne, R as ge, n as oi, b as _a, u as va, E as ya, i as ka, D as Ca, d as Na, c as Ta, e as Aa, I as La, U as Sa, S as Ma, C as Ia, f as ct, g as za, h as Ha, F as Ea, H as Ra, T as Oa, j as Z, k as Pa, l as Ba, o as Da, O as $a, p as Fa, q as Va, r as ja, L as Ua, s as Wa, t as qa, v as Ka, w as Ga, x as Ct, P as Xa, y as Ya, z as Za, G as Ja, A as Qa, J as eo, K as to, M as io, Q as no, V as ro, W as sn, X as ln, Y as dn, Z as ci, _ as si, $ as ao, a0 as oo, a1 as co, a2 as so, a3 as lo, a4 as Mi } from "./tiptap-BGOnVdZm.js";
...
import { u as F, C as po, E as wo, l as j, B as _o, I as Tt, V as Kt, M as vo, D as xn, a as yo, b as ko, c as Ii, d as bn, e as Co, f as Ke, g as Ge, h as ui, T as xt, i as bt, j as pt } from "./locales-Csi2K74Z.js";
...
import { proxy as zt, useSnapshot as Ht } from "valtio";
...
import { TextAlignCenterIcon as Io, TextAlignJustifyIcon as zo, TextAlignLeftIcon as Ho, TextAlignRightIcon as Eo } from "@radix-ui/react-icons";
...
const w = je.forwardRef(
  (e, t) => {
    ...
    return /* @__PURE__ */ m(et, { children: [
      ...
      n && /* @__PURE__ */ r(He, { ...s, children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-items-center richtext-text-center richtext-max-w-24", children: [
  ...
  ({ asChild: e, ...t }, i) => {
    ...
    return /* @__PURE__ */ m(et, { children: [
      ...
      /* @__PURE__ */ r(He, { children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-items-center richtext-text-center richtext-max-w-24", children: [
...
const ve = G.Root, ye = G.Trigger, zi = G.Portal, Hi = G.Sub, Yt = $.forwardRef(({ className: e, inset: t, children: i, ...n }, a) => /* @__PURE__ */ m(
  G.SubTrigger,
  {
    ref: a,
    className: P(
...
Yt.displayName = G.SubTrigger.displayName;
...
const Vo = ht.Provider, et = ht.Root, tt = ht.Trigger, He = $.forwardRef(({ className: e, sideOffset: t = 4, ...i }, n) => /* @__PURE__ */ r(
  ht.Content,
  {
    ref: n,
    sideOffset: t,
...
function sc({ editor: e, node: t, updateAttributes: i }) {
  const n = J(null), a = e.isActive(De.name), { data: o, width: c, height: s } = t.attrs, [d, l] = p(null), [h, u] = p(!0), [f, g] = p(null), [x, b] = p(!1), [N, k] = p(100), v = A(
    (T) => {
      T && b(!0);
    },
    [b]
...
const Ee = oe.Root, Re = oe.Trigger, mc = oe.Portal, Mn = $.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  oe.Overlay,
  {
    ref: i,
    className: P(
...
a-->b`, Hc = ({ editor: e, attrs: t, extension: i }) => {
  const { alt: n, align: a } = t, [o, c] = p(decodeURIComponent(n ?? Bi)), [s, d] = p(""), [l, h] = p(!1), u = J(null), f = i == null ? void 0 : i.options.upload, g = async (N) => {
    try {
      const { svg: k } = await At.render("mermaid-svg", N);
      d(k);
    } catch {
      d("");
    }
          ...
          /* @__PURE__ */ r(it, { children: /* @__PURE__ */ r(
            U,
            {
              ...
              onClick: async () => {
                if (o !== "") {
                  if (o) {
                    const N = u.current.querySelector("svg"), { width: k, height: v } = N.getBoundingClientRect(), _ = `mermaid-${Hn()}.svg`;
                    let y = hn(N.outerHTML);
                    if (f) {
                      const T = vi(y, _);
                      y = await f(T);
                    }
...
function Bc(e) {
  const { lang: t } = F(), i = ut(e.editor, en.name), n = Ec(e.editor, en.name), a = ({ editor: c }) => {
...
function $c(e) {
  ...
  return /* @__PURE__ */ m(se, { modal: !0, children: [
    ...
    /* @__PURE__ */ r(re, { hideWhenDetached: !0, className: "richtext-w-full", align: "start", side: "bottom", children: /* @__PURE__ */ r(En, { editor: e.editor, onSetLink: t }) })
  ] });
}
...
function Uc({ editor: e, disabled: t, bubbleMenu: i }) {
  const n = e.extensionManager.extensions.map((o) => o.name), a = () => {
    ...
    return [
      ...
      n.includes(Zn.name) && !((l = i == null ? void 0 : i.imageGifConfig) != null && l.hidden) ? /* @__PURE__ */ r(Gs, { editor: e, disabled: t }, "imageGif") : null,
      ...
      (k = i == null ? void 0 : i.textConfig) != null && k.hidden ? null : /* @__PURE__ */ r(Ds, { editor: e, disabled: t }, "text")
    ];
  };
...
function ts(e, t) {
  ...
  }, [s, e == null ? void 0 : e.disabled]), H(() => ((e == null ? void 0 : e.resetCSS) !== !1 && es(qc, "react-tiptap-reset"), () => {
  ...
  }, []), s ? /* @__PURE__ */ r("div", { className: "reactjs-tiptap-editor", children: /* @__PURE__ */ m(Vo, { delayDuration: 0, disableHoverableContent: !0, children: [
...
function ns({ editor: e, disabled: t }) {
  const { t: i } = F(), [n, a] = p(!1), [o, c] = p(0), s = A(() => {
    var h;
    a(window.innerHeight < 500);
    const l = ((h = window.visualViewport) == null ? void 0 : h.height) ?? 0;
    c(l + window.scrollY - is);
  }, []);
  H(() => {
    var l;
    return (l = window.visualViewport) == null || l.addEventListener("resize", s), s(), () => {
      var h;
      (h = window.visualViewport) == null || h.removeEventListener("resize", s);
    };
  }, [s]);
  const d = B(() => {
    ...
    let u = [];
    for (const f of h) {
      const { button: g, divider: x = !1, spacer: b = !1, toolbar: N = !0 } = f.options;
      if (!g || !nc(g) || !N)
        continue;
      const k = g({
        editor: e,
  ...
  return console.log("top", o), /* @__PURE__ */ r(
    "div",
    {
      style: {
      ...
      children: /* @__PURE__ */ r("div", { className: "richtext-flex richtext-gap-x-1", children: d.map((l, h) => {
        var f, g;
        const u = l.button.component;
        return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center", children: [
          (l == null ? void 0 : l.spacer) && /* @__PURE__ */ r(he, { orientation: "vertical", className: "!richtext-h-[16px] !richtext-mx-[10px]" }),
          /* @__PURE__ */ r(
            u,
            {
              ...l.button.componentProps,
              disabled: t || ((g = (f = l == null ? void 0 : l.button) == null ? void 0 : f.componentProps) == null ? void 0 : g.disabled)
            }
          ),
          (l == null ? void 0 : l.divider) && /* @__PURE__ */ r(he, { orientation: "vertical", className: "!richtext-h-auto !richtext-mx-2" })
        ] }, `toolbar-item-${h}`);
      }) })
    }
  );
...
const gt = {
  ...
  BetweenHorizonalStart: Hr,
  BetweenVerticalStart: Er,
...
function ni(e, t, i) {
  ...
  if (!n)
    return e;
  const c = Es((n.attrs.indent || 0) + i, 0, 7);
  if (c === n.attrs.indent)
    return e;
  const s = {
    ...n.attrs,
...
function Os(e) {
  var M, L, S;
  const { pluginKey: t = Na } = e, { t: i } = F(), [n, a] = p(null), [o, c] = p(-1), s = J(null), d = J(null), [l, h] = p(!1), u = e.editor.extensionManager.extensions.some((C) => C.name === "textAlign"), f = e.editor.extensionManager.extensions.some((C) => C.name === "indent"), g = e.editor.extensionManager.extensions.some((C) => C.name === "clear");
  H(() => {
  ...
  function N() {
    ...
    const { $anchor: C } = e.editor.state.selection, D = C.node(1) || e.editor.state.selection.node;
  ...
  function v() {
    const C = ni(e.editor.state.tr, o, 1);
  ...
  function I() {
    var C;
    if (o !== -1) {
      const D = (n == null ? void 0 : n.nodeSize) || 0, R = o + D, E = (n == null ? void 0 : n.type.name) === "paragraph" && ((C = n == null ? void 0 : n.content) == null ? void 0 : C.size) === 0, z = E ? o + 2 : R + 2;
      e.editor.chain().command(({ dispatch: K, tr: X, state: Oe }) => K ? (E ? X.insertText("/", o, o + 1) : X.insert(
        R,
        Oe.schema.nodes.paragraph.create(null, [Oe.schema.text("/")])
      ), K(X)) : !0).focus(z).run();
    }
  }
  H(() => (l ? e.editor.commands.setMeta("lockDragHandle", !0) : e.editor.commands.setMeta("lockDragHandle", !1), () => {
        ...
        /* @__PURE__ */ m(ve, { open: l, onOpenChange: O, children: [
          /* @__PURE__ */ m("div", { className: "richtext-relative richtext-flex richtext-flex-col", children: [
            /* @__PURE__ */ m(et, { children: [
              ...
              /* @__PURE__ */ r(He, { children: i("editor.draghandle.tooltip") })
            ] }),
          ...
          /* @__PURE__ */ m(be, { className: "richtext-w-48", align: "start", side: "bottom", sideOffset: 0, children: [
            ...
            u ? /* @__PURE__ */ m(Hi, { children: [
              ...
              /* @__PURE__ */ r(zi, { children: /* @__PURE__ */ m(Zt, { children: [
...
function Fs({ editor: e, disabled: t }) {
  var b, N, k, v, _, y, T, I, O, M, L, S, C, D, R, E, z, K;
      ...
      children: t ? /* @__PURE__ */ r(q, {}) : /* @__PURE__ */ m("div", { className: "richtext-min-w-32 richtext-flex richtext-flex-row richtext-h-full richtext-items-center richtext-leading-none richtext-gap-0.5 richtext-p-2 richtext-w-full richtext-bg-background richtext-rounded-lg richtext-shadow-sm !richtext-border richtext-border-border", children: [
        ...
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((v = (k = e == null ? void 0 : e.can()) == null ? void 0 : k.addColumnAfter) != null && v.call(k))
          }
        ),
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((y = e == null ? void 0 : (_ = e.can()).deleteColumn) != null && y.call(_))
          }
        ),
        ...
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((D = (C = e == null ? void 0 : e.can()) == null ? void 0 : C.mergeCells) != null && D.call(C))
          }
        ),
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((E = (R = e == null ? void 0 : e.can()) == null ? void 0 : R.splitCell) != null && E.call(R))
          }
        ),
        /* @__PURE__ */ r(he, { orientation: "vertical", className: "!richtext-mx-1 !richtext-my-2 !richtext-h-[16px]" }),
        /* @__PURE__ */ r(
        ...
        /* @__PURE__ */ m(
          ze,
          {
            ...
            children: [
              ...
              !!((o = n == null ? void 0 : n.shortcutKeys) != null && o.length) && /* @__PURE__ */ r(yn, { className: "richtext-pl-4", children: (c = n == null ? void 0 : n.shortcutKeys) == null ? void 0 : c.map((s) => Et(s)).join(" ") })
            ]
          }
        ),
      ...
      re,
      {
        ...
        children: (i = e == null ? void 0 : e.items) == null ? void 0 : i.map((n, a) => {
          ...
          return /* @__PURE__ */ m(et, { children: [
            ...
            /* @__PURE__ */ m(He, { className: "richtext-flex richtext-flex-col richtext-items-center", children: [
...
function $l(e, t) {
  ...
  function h() {
    ...
    if (e.items.length === 0)
      return !1;
    let v = i - 1, _ = a;
    v < 0 && (_ = a - 1, v = ((y = e.items[_]) == null ? void 0 : y.commands.length) - 1 || 0), _ < 0 && (_ = e.items.length - 1, v = e.items[_].commands.length - 1), n(v), o(_);
  }
  function u() {
    if (e.items.length === 0)
      return !1;
    ...
    let _ = i + 1, y = a;
    v.length - 1 < _ && (_ = 0, y = a + 1), e.items.length - 1 < y && (y = 0), n(_), o(y);
  }
  function f() {
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      ref: c,
      children: (N = e == null ? void 0 : e.items) != null && N.length ? /* @__PURE__ */ r("div", { className: "richtext-grid richtext-grid-cols-1 richtext-gap-0.5 richtext-min-w-48", children: (k = e == null ? void 0 : e.items) == null ? void 0 : k.map((v, _) => /* @__PURE__ */ m(dt, { children: [
        ...
        v.commands.map((y, T) => /* @__PURE__ */ m(
          "button",
          {
            ...
            children: [
              ...
              y.iconName && /* @__PURE__ */ r(V, { name: y.iconName, className: "!richtext-mr-1 !richtext-text-lg" }),
              y.label
            ]
          },
          `command-${T}`
...
function Vl(e) {
  ...
  const [t, i] = p({
    ...
    var xe;
    const { src: L, alt: S, width: C, height: D, flipX: R, flipY: E } = (xe = e == null ? void 0 : e.node) == null ? void 0 : xe.attrs, z = Nt(C) ? `${C}px` : C, K = Nt(D) ? `${D}px` : D, X = [];
  ...
  function k(L, S) {
    ...
    const C = n.width, D = n.height, R = C / D;
    let E = Number(e.node.attrs.width), z = Number(e.node.attrs.height);
    const K = t.width;
    E && !z ? (E = E > K ? K : E, z = Math.round(E / R)) : z && !E ? (E = Math.round(z * R), E = E > K ? K : E) : !E && !z ? (E = C > K ? K : C, z = Math.round(E / R)) : E = E > K ? K : E, Xe(() => {
      s(!0), l({
        x: L.clientX,
        y: L.clientY,
        w: E,
  ...
  const v = A(
    Se((L) => {
      if (L.preventDefault(), L.stopPropagation(), !c)
        return;
      const { x: S, w: C, dir: D } = d, R = (L.clientX - S) * (/l/.test(D) ? -1 : 1), E = mn(C + R, ui, t.width);
      e.updateAttributes({
        width: E,
        height: null
      });
...
function jl({ editor: e, imageInline: t, onClose: i }) {
  ...
  async function N() {
    var _, y;
    try {
      const T = await vi(l, ((_ = f == null ? void 0 : f.file) == null ? void 0 : _.name) || "image.png"), I = (y = e.extensionManager.extensions.find(
        (M) => M.name === "image"
  ...
  function k(_) {
    var y;
    _.preventDefault(), (y = u.current) == null || y.click();
  }
  const v = async (_) => {
    var O;
    const y = (O = _ == null ? void 0 : _.target) == null ? void 0 : O.files;
    if (!e || e.isDestroyed || y.length === 0)
      return;
    const T = y[0], I = await zc(T);
    o(!0), g({
      src: I.src,
      file: T
    });
...
function Ul(e) {
  ...
  return /* @__PURE__ */ m(Ee, { open: i.isOpen, onOpenChange: Fe.setOpen, children: [
    /* @__PURE__ */ r(Re, { asChild: !0, children: /* @__PURE__ */ r(
      w,
      {
        icon: e.icon,
...
function dd({ editor: e, ...t }) {
  ...
  return H(() => {
    ...
    if (!e)
      return;
    const b = e.extensionManager.extensions.find((k) => k.name === gd.name);
    if (!b)
      return;
    const N = () => {
      if (!u)
...
function Yd(e) {
  ...
  async function d(u) {
    ...
    if (ac(e.editor, "image")) {
      const k = (N = e.editor.extensionManager.extensions.find(
        (v) => v.name === "importWord"
      )) == null ? void 0 : N.options;
      if (k && typeof k.upload == "function") {
        const v = [];
        for (const y of x) {
          const T = y.getAttribute("src"), I = Gd(T, "image/jpeg"), O = Xd(I, "image.jpeg");
          v.push(O);
        }
        const _ = await k.upload(v);
        for (let y = 0; y < x.length; y++) {
          const T = x[y];
          T.setAttribute("src", _[y].src);
...
function vh({ editor: e, node: t, updateAttributes: i, deleteNode: n, extension: a }) {
  var T;
  const o = J(), c = Bt(), { hasTrigger: s, fileName: d, fileSize: l, fileExt: h, fileType: u, url: f, error: g } = t.attrs, [x, b] = p(!1), { t: N } = F(), k = (T = a == null ? void 0 : a.options) == null ? void 0 : T.upload, v = A(() => {
...
function yh(e) {
  ...
  const [t, i] = p({
    ...
    var E;
    const { src: M, alt: L, width: S, height: C } = (E = e == null ? void 0 : e.node) == null ? void 0 : E.attrs, D = Nt(S) ? `${S}px` : S, R = Nt(C) ? `${C}px` : C;
    return {
      src: M || void 0,
      alt: L || void 0,
      style: {
  ...
  function N(M, L) {
    ...
    const S = n.width, C = n.height, D = S / C;
    let R = Number(e.node.attrs.width), E = Number(e.node.attrs.height);
    const z = t.width;
    R && !E ? (R = R > z ? z : R, E = Math.round(R / D)) : E && !R ? (R = Math.round(E * D), R = R > z ? z : R) : !R && !E ? (R = S > z ? z : S, E = Math.round(R / D)) : R = R > z ? z : R, Xe(() => {
      s(!0), l({
        x: M.clientX,
        y: M.clientY,
        w: R,
  ...
  const k = A(
    Se((M) => {
      if (M.preventDefault(), M.stopPropagation(), !c)
        return;
      const { x: L, w: S, dir: C } = d, D = (M.clientX - L) * (/l/.test(C) ? -1 : 1), R = mn(S + D, ui, t.width);
      e.updateAttributes({
        width: R,
        height: null
      });
  ...
  return H(() => (T.observe(e.editor.view.dom), () => {
    T.disconnect();
          ...
          /* @__PURE__ */ r(it, { children: /* @__PURE__ */ r(
            U,
            {
              ...
              onClick: async () => {
                if (i !== "") {
                  if (i) {
                    const f = d.current.querySelector("svg"), { width: g, height: x } = f.getBoundingClientRect(), b = `mermaid-${Hn()}.svg`;
...
function Th({ editor: e, node: t, updateAttributes: i, getPos: n, selected: a }) {
  const [o, c] = p({
    ...
    const { src: S, alt: C, width: D, height: R } = t == null ? void 0 : t.attrs, E = Mi(D) ? `${D}px` : D, z = Mi(R) ? `${R}px` : R;
    return {
      src: S || void 0,
      alt: C || void 0,
      style: {
  ...
  function y(S, C) {
    ...
    const D = s.width, R = s.height, E = D / R;
    let z = Number(t.attrs.width), K = Number(t.attrs.height);
    const X = o.width;
    z && !K ? (z = z > X ? X : z, K = Math.round(z / E)) : K && !z ? (z = Math.round(K * E), z = z > X ? X : z) : !z && !K ? (z = D > X ? X : D, K = Math.round(z / E)) : z = z > X ? X : z, Xe(() => {
      u(!0), g({
        x: S.clientX,
        y: S.clientY,
        w: z,
  ...
  const T = A(
    Se((S) => {
      if (S.preventDefault(), S.stopPropagation(), !h)
        return;
      const { x: C, w: D, dir: R } = f, E = (S.clientX - C) * (/l/.test(R) ? -1 : 1), z = Sn(D + E, ui, o.width);
      i({
        width: z,
        height: null
      });
