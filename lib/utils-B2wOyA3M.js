...
import Ve, { useState as p, useRef as Y, useEffect as z, useCallback as A, useMemo as D, Fragment as st, forwardRef as At, useImperativeHandle as Lt } from "react";
...
import { al as co, am as ee, an as si, ao as li, ap as so, aq as ln, ar as lo, as as Le, e as Mt, d as Se, at as dn, au as ho, P as pe, a as we, a1 as Fe, a2 as Ue, av as di, aw as uo, ax as Ct, ay as hn, ai as mo } from "./vendor-DCd8XlAt.js";
import { bundledThemes as un, bundledLanguages as mn, createHighlighter as fo } from "shiki";
import { u as V, C as go, E as xo, l as j, B as bo, I as Nt, V as Kt, M as po, D as fn, a as wo, b as _o, c as Si, d as gn, e as vo, f as We, g as Ke, h as hi, T as gt, i as xt, j as bt } from "./locales-BOgJDyKy.js";
...
const Ie = $.forwardRef(({ className: e, children: t, checked: i, ...n }, a) => /* @__PURE__ */ m(
  q.CheckboxItem,
  {
    ref: a,
    className: P(
...
Ie.displayName = q.CheckboxItem.displayName;
...
const pi = Me.Root, Ot = $.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  Me.List,
  {
    ref: i,
    className: P(
...
Ot.displayName = Me.List.displayName;
...
Ge.displayName = Me.Trigger.displayName;
...
Xe.displayName = Me.Content.displayName;
const Do = li(
...
const Bo = lt.Provider, Je = lt.Root, Qe = lt.Trigger, ze = $.forwardRef(({ className: e, sideOffset: t = 4, ...i }, n) => /* @__PURE__ */ r(
  lt.Content,
  {
    ref: n,
    sideOffset: t,
...
ze.displayName = lt.Content.displayName;
...
function Uo({ editor: e, ...t }) {
  const i = dt(e, $e.name, {
    text: "",
    defaultShowPicker: !1
  }), { text: n, defaultShowPicker: a } = i, [o, c] = p(""), [s, d] = p(!1), l = A(() => e.isActive($e.name), [e]), h = A(() => Ye($e.name, e), [e]), u = A(() => {
    e.chain().focus().setKatex({ text: o }).run(), d(!1);
  }, [e, o]);
  z(() => {
    a && (d(!0), e.chain().updateAttributes($e.name, { defaultShowPicker: !1 }).focus().run());
  }, [e, a, d]), z(() => {
    s && c(n || "");
  }, [s]);
  const f = D(() => {
  ...
  return /* @__PURE__ */ r(
    ce,
    {
      ...
      children: t != null && t.disabled ? /* @__PURE__ */ r(K, {}) : /* @__PURE__ */ r("div", { className: "richtext-p-2 richtext-bg-white !richtext-border richtext-rounded-lg richtext-shadow-sm dark:richtext-bg-black richtext-border-neutral-200 dark:richtext-border-neutral-800", children: s ? /* @__PURE__ */ m(K, { children: [
        ...
        /* @__PURE__ */ r(w, { tooltip: "Edit", action: () => d(!s), children: /* @__PURE__ */ r(tn, { size: 16 }) }),
        /* @__PURE__ */ r(w, { tooltip: "Delete", action: h, children: /* @__PURE__ */ r(nn, { size: 16 }) })
      ] }) })
    }
  );
}
...
function ac({ editor: e, node: t, updateAttributes: i }) {
  const n = Y(null), a = e.isActive(Pe.name), { data: o, width: c, height: s } = t.attrs, [d, l] = p(null), [h, u] = p(!0), [f, g] = p(null), [x, b] = p(!1), [C, T] = p(100), v = A(
    (N) => {
      N && b(!0);
    },
    [b]
...
const oc = Ve.memo(ac, (e, t) => !!si(e.node.attrs, t.node.attrs));
function cc(e, t = "{}") {
  try {
...
const Ee = oe.Root, He = oe.Trigger, dc = oe.Portal, Ln = $.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  oe.Overlay,
  {
    ref: i,
    className: P(
...
function bc({ editor: e }) {
  const { t } = V(), { width: i } = xc(e), n = dt(e, Pe.name, {
    defaultShowPicker: !1,
    createUser: "",
    width: 0,
    height: 0
    ...
    fc(n);
  }, [e, n]), h = A(() => e.isActive(Pe.name), [e]), u = A(() => Ye(Pe.name, e), [e]);
  return z(() => {
...
function kc({ editor: e, node: t, updateAttributes: i }) {
  ...
  function l() {
    s && e.chain().updateAttributes(De.name, {
      url: s
...
function Cc({ editor: e }) {
  const { t } = V(), { width: i, height: n, url: a } = dt(e, De.name, {
    width: 0,
    height: 0,
    url: "",
    defaultShowPicker: !1
  ...
  const h = A(() => {
    e.chain().updateAttributes(De.name, {
      url: s
    ...
    (C) => {
      e.chain().updateAttributes(De.name, C).setNodeSelection(e.state.selection.from).focus().run();
    },
    [e]
  ), x = A(() => e.isActive(De.name) && !a, [e, a]), b = A(() => Ye(De.name, e), [e]);
...
a-->b`, Mc = ({ editor: e, attrs: t, extension: i }) => {
  const { alt: n, align: a } = t, [o, c] = p(decodeURIComponent(n ?? Oi)), [s, d] = p(""), [l, h] = p(!1), u = Y(null), f = i == null ? void 0 : i.options.upload, g = async (C) => {
    try {
      const { svg: T } = await Tt.render("mermaid-svg", C);
      d(T);
    } catch {
      d("");
    }
          ...
          /* @__PURE__ */ r(et, { children: /* @__PURE__ */ r(
            U,
            {
              ...
              onClick: async () => {
                if (o !== "") {
                  if (o) {
                    const C = u.current.querySelector("svg"), { width: T, height: v } = C.getBoundingClientRect(), _ = `mermaid-${In()}.svg`;
                    let y = ln(C.outerHTML);
                    if (f) {
                      const N = _i(y, _);
                      y = await f(N);
                    }
...
function Vc({ editor: e, disabled: t, bubbleMenu: i }) {
  const n = e.extensionManager.extensions.map((o) => o.name), a = () => {
    ...
    return [
      ...
      (C = i == null ? void 0 : i.floatingMenuConfig) != null && C.hidden ? null : /* @__PURE__ */ r(Es, { editor: e, disabled: t }, "content"),
...
function es({ editor: e, disabled: t }) {
  const { t: i } = V(), { isKeyboardVisible: n } = Qc(), a = D(() => ["Undo2", "Redo2", "Bold", "Italic", "Type", "KatexIcon", "List", "ListOrdered", "Code2", "Attachment"], []), o = D(() => {
    ...
    var d;
    return a.includes((d = s.button.componentProps) == null ? void 0 : d.icon);
  }), [o, a]);
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ r("div", { className: "richtext-flex richtext-gap-x-1", children: c.map((s, d) => {
        ...
        return console.log("tool-bar-items", s), console.log("tool-bar-key", d), /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center", children: [
          (s == null ? void 0 : s.spacer) && /* @__PURE__ */ r(fe, { orientation: "vertical", className: "!richtext-h-[16px] !richtext-mx-[10px]" }),
          /* @__PURE__ */ r(
            l,
            {
          ...
          (s == null ? void 0 : s.divider) && /* @__PURE__ */ r(fe, { orientation: "vertical", className: "!richtext-h-auto !richtext-mx-2" })
        ] }, `toolbar-item-${d}`);
      }) })
    }
  );
...
function zs(e, t, i, n) {
  ...
  if (!a || !o || !(o instanceof Se || o instanceof dn))
    return e;
  const { from: c, to: s } = o;
...
function Es(e) {
  var M, S, L;
  const { pluginKey: t = ya } = e, { t: i } = V(), [n, a] = p(null), [o, c] = p(-1), s = Y(null), d = Y(null), [l, h] = p(!1), u = e.editor.extensionManager.extensions.some((k) => k.name === "textAlign"), f = e.editor.extensionManager.extensions.some((k) => k.name === "indent"), g = e.editor.extensionManager.extensions.some((k) => k.name === "clear");
  z(() => {
  ...
  function C() {
    ...
    const { $anchor: k } = e.editor.state.selection, B = k.node(1) || e.editor.state.selection.node;
  ...
  function v() {
    const k = ii(e.editor.state.tr, o, 1);
  ...
  function I() {
    var k;
    if (o !== -1) {
      const B = (n == null ? void 0 : n.nodeSize) || 0, R = o + B, H = (n == null ? void 0 : n.type.name) === "paragraph" && ((k = n == null ? void 0 : n.content) == null ? void 0 : k.size) === 0, E = H ? o + 2 : R + 2;
  ...
  z(() => (l ? e.editor.commands.setMeta("lockDragHandle", !0) : e.editor.commands.setMeta("lockDragHandle", !1), () => {
    ...
    var k;
    (k = e.editor) != null && k.isDestroyed && d.current && (e.editor.unregisterPlugin(t), d.current = null);
  }, [(M = e.editor) == null ? void 0 : M.isDestroyed]);
  const O = (k) => {
    e != null && e.disabled || h(k);
  };
  return /* @__PURE__ */ r(
    "div",
    {
                ...
                /* @__PURE__ */ m(Je, { children: [
                  /* @__PURE__ */ r(Qe, { asChild: !0, disabled: e == null ? void 0 : e.disabled, children: /* @__PURE__ */ r(
                    U,
                    {
                      ...
                      disabled: e == null ? void 0 : e.disabled,
                      onMouseUp: (k) => {
                        k.preventDefault(), !(e != null && e.disabled) && h(!0);
                      },
                      type: "button",
...
function Os(e) {
  const { t, lang: i } = V(), n = ({ editor: o }) => {
    ...
    return s.pos === d ? !1 : c instanceof Se;
...
function Ps({ editor: e, disabled: t }) {
  var f, g, x, b, C, T, v, _, y, N, I, O, M, S;
      ...
      children: t ? /* @__PURE__ */ r(K, {}) : /* @__PURE__ */ m("div", { style: { width: 300, overflowX: "auto" }, className: "richtext-flex richtext-flex-row richtext-h-full richtext-items-center richtext-leading-none richtext-gap-0.5 richtext-p-2 richtext-bg-background richtext-rounded-lg richtext-shadow-sm !richtext-border richtext-border-border", children: [
        ...
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((T = e == null ? void 0 : (C = e.can()).deleteColumn) != null && T.call(C))
          }
        ),
        ...
        /* @__PURE__ */ r(
          w,
          {
            ...
            disabled: !((N = (y = e == null ? void 0 : e.can()) == null ? void 0 : y.addRowAfter) != null && N.call(y))
          }
        ),
        /* @__PURE__ */ r(
          w,
...
function Fi({
  ...
  return at(e, (c) => c.type.name === t).forEach((c) => {
    ...
    for (const g of f) {
      for (const x of g) {
        const b = s + x.content.length, C = Ue.inline(s, b, {
          style: `color: ${x.color}`
        });
        a.push(C), s = b;
      }
...
function fl(e) {
  ...
  return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-h-[32px]", children: [
    /* @__PURE__ */ r(w, { tooltip: e == null ? void 0 : e.tooltip, disabled: e == null ? void 0 : e.disabled, action: a, children: /* @__PURE__ */ r("span", { className: "richtext-flex richtext-items-center richtext-justify-center richtext-text-sm", children: /* @__PURE__ */ r(ml, { fill: t }) }) }),
    /* @__PURE__ */ r(
      En,
      {
        selectedColor: t,
      ...
      new pe({
        props: {
          handleClick: (e, t) => {
            ...
            if (!o)
              return !1;
            const c = n.resolve(o.from), s = n.resolve(o.to), d = a.setSelection(new Se(c, s));
            e.dispatch(d);
          }
        }
      })
...
function ji({ state: e, dispatch: t, type: i }) {
  ...
  if (t && n && a) {
    ...
    return l.setSelection(Se.near(l.doc.resolve(d))), t(l), !0;
  }
  return !1;
}
    ...
    return {
      insertColumns: (e) => ({ tr: t, dispatch: i, editor: n }) => {
        ...
        if (i) {
          ...
          t.replaceSelectionWith(a).scrollIntoView().setSelection(Se.near(t.doc.resolve(o)));
        }
        return !0;
      },
...
const Ll = Z.create({
  ...
  addExtensions() {
    ...
    ), this.options.text !== !1 && e.push(Ga.configure()), console.log("this.options", this.options), this.options.textBubble !== !1 && e.push(Al.configure()), this.options.gapcursor !== !1 && e.push(Xa.configure()), this.options.dropcursor !== !1 && e.push(
      Za.configure({
...
function El(e, t) {
  ...
  if (!i || !n || !(i instanceof Se || i instanceof dn))
    return e;
...
function Pl(e) {
  ...
  return e.forEach((i) => {
    i.name.toLowerCase() === "heading" && i.options.levels.forEach((n) => {
      ...
      shouldBeHidden: (n) => n.isActive("columns"),
      action: ({ editor: n, range: a }) => {
        n.chain().focus().deleteRange(a).run(), Be.setOpen(!0);
      }
...
function Dl(e, t) {
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      ref: c,
      children: (C = e == null ? void 0 : e.items) != null && C.length ? /* @__PURE__ */ r("div", { className: "richtext-grid richtext-grid-cols-1 richtext-gap-0.5 richtext-min-w-48", children: (T = e == null ? void 0 : e.items) == null ? void 0 : T.map((v, _) => /* @__PURE__ */ m(st, { children: [
...
function $l(e) {
  ...
  const [t, i] = p({
    ...
    var Ni;
    const { src: S, alt: L, width: k, height: B, flipX: R, flipY: H } = (Ni = e == null ? void 0 : e.node) == null ? void 0 : Ni.attrs, E = Ct(k) ? `${k}px` : k, G = Ct(B) ? `${B}px` : B, J = [];
  ...
  function T(S, L) {
    ...
    const k = n.width, B = n.height, R = k / B;
    let H = Number(e.node.attrs.width), E = Number(e.node.attrs.height);
    const G = t.width;
    H && !E ? (H = H > G ? G : H, E = Math.round(H / R)) : E && !H ? (H = Math.round(E * R), H = H > G ? G : H) : !H && !E ? (H = k > G ? G : k, E = Math.round(H / R)) : H = H > G ? G : H, qe(() => {
      s(!0), l({
        x: S.clientX,
        y: S.clientY,
        w: H,
  ...
  const v = A(
    Le((S) => {
      if (S.preventDefault(), S.stopPropagation(), !c)
        return;
      const { x: L, w: k, dir: B } = d, R = (S.clientX - L) * (/l/.test(B) ? -1 : 1), H = hn(k + R, hi, t.width);
      e.updateAttributes({
        width: H,
        height: null
      });
  ...
  const I = D(() => new ResizeObserver(() => C()), [C]);
...
function Vl({ editor: e, imageInline: t, onClose: i }) {
  const { t: n } = V(), [a, o] = p(!1), c = Ve.useRef(null), [s, d] = Ve.useState(), [l, h] = Ve.useState(""), u = Y(null), [f, g] = p({
    src: "",
    file: null
  });
  function x(_) {
  ...
  function b(_, y) {
    ...
    N.width = y.width * I, N.height = y.height * O;
  ...
  async function C() {
    var _, y;
    try {
      const N = await _i(l, ((_ = f == null ? void 0 : f.file) == null ? void 0 : _.name) || "image.png"), I = (y = e.extensionManager.extensions.find(
        (M) => M.name === "image"
...
function Fl(e) {
  ...
  async function d(u) {
    ...
    let b = "";
    x.upload ? b = await x.upload(g) : b = URL.createObjectURL(g), e.editor.chain().focus().setImageInline({ src: b, inline: c }).run(), Be.setOpen(!1), s(!1);
  }
  function l(u) {
    u.preventDefault(), u.stopPropagation(), e.editor.chain().focus().setImageInline({ src: n, inline: c }).run(), Be.setOpen(!1), s(!1);
  }
  function h(u) {
    var f;
    u.preventDefault(), (f = o.current) == null || f.click();
  }
  return /* @__PURE__ */ m(Ee, { open: i.isOpen, onOpenChange: Be.setOpen, children: [
    /* @__PURE__ */ r(He, { asChild: !0, children: /* @__PURE__ */ r(
      w,
      {
        icon: e.icon,
    ...
    for (const c of n) {
      ...
      d.setMeta(je, {
        ...
        async (h) => {
          ...
          const C = a.state.tr.replaceWith(f, f, x).setMeta(je, { remove: [s] });
          a.dispatch(C);
        },
        () => {
...
function Yl(e) {
  ...
  return /* @__PURE__ */ m(Ee, { open: o.isOpen, onOpenChange: rt.setOpen, children: [
    /* @__PURE__ */ r(He, { asChild: !0, children: /* @__PURE__ */ r(
      w,
      {
        icon: e.icon,
...
function sd({ editor: e, ...t }) {
  ...
  return z(() => {
    ...
    const C = () => {
      ...
      a((_) => _ !== T ? T : _), c((_) => si(_, v) ? _ : v);
    };
    return window.addEventListener(ni, C), () => {
      b && window.removeEventListener(ni, C);
    };
  }, [u, e]), /* @__PURE__ */ m(
    se,
    {
...
const ni = "ON_SEARCH_RESULTS", Re = new CustomEvent(ni), md = Z.create({
  name: "search",
  addOptions() {
    var e;
    return {
  ...
  addCommands() {
    return {
      setSearchTerm: (e) => ({ state: t, dispatch: i }) => (this.options.searchTerm = e, this.storage.results = [], this.storage.currentIndex = 0, window.dispatchEvent(Re), nt(t, i), !1),
      ...
      replace: () => ({ state: e, dispatch: t }) => {
        ...
        return o ? (Gi(i, [o], { state: e, dispatch: t }), this.storage.results.splice(n, 1)) : (Gi(i, a, { state: e, dispatch: t }), this.storage.results.shift()), window.dispatchEvent(Re), nt(e, t), !1;
      },
      replaceAll: () => ({ state: e, tr: t, dispatch: i }) => {
        const { replaceTerm: n } = this.options, { results: a } = this.storage;
        return ud(n, a, { tr: t, dispatch: i }), this.storage.currentIndex = -1, this.storage.results = [], window.dispatchEvent(Re), nt(e, i), !1;
      },
      goToPrevSearchResult: () => ({ view: e, tr: t }) => {
        ...
        return this.storage.currentIndex = o, window.dispatchEvent(Re), Xi({
          view: e,
          tr: t,
          searchResults: a,
      ...
      goToNextSearchResult: () => ({ view: e, tr: t }) => {
        ...
        return this.storage.currentIndex = o, this.options.onChange && this.options.onChange(), window.dispatchEvent(Re), Xi({
          view: e,
          tr: t,
          searchResults: a,
          searchResultCurrentClass: i,
        ...
        state: {
          ...
          apply(t) {
            ...
            if (n || a) {
              ...
              if (e.storage.results = h, e.storage.currentIndex > h.length - 1 && (e.storage.currentIndex = 0), window.dispatchEvent(Re), t.getMeta("directDecoration")) {
...
const Oe = Hd("EMOJI_PICKER", 20), Zi = [
  {
...
function $d({ editor: e, ...t }) {
  ...
  z(() => {
    o && e.chain().updateAttributes($e.name, { defaultShowPicker: !1 }).focus().run();
  }, [e, o]);
  const l = D(() => {
    try {
  ...
  async function d(u) {
    ...
    if (ic(e.editor, "image")) {
      ...
      if (T && typeof T.upload == "function") {
        const v = [];
        for (const y of x) {
          const N = y.getAttribute("src"), I = Kd(N, "image/jpeg"), O = qd(I, "image.jpeg");
          v.push(O);
        }
        const _ = await T.upload(v);
        for (let y = 0; y < x.length; y++) {
          const N = x[y];
          N.setAttribute("src", _[y].src);
...
function wh({ editor: e, node: t, updateAttributes: i, deleteNode: n, extension: a }) {
  var N;
  const o = Y(), c = Pt(), { hasTrigger: s, fileName: d, fileSize: l, fileExt: h, fileType: u, url: f, error: g } = t.attrs, [x, b] = p(!1), { t: C } = V(), T = (N = a == null ? void 0 : a.options) == null ? void 0 : N.upload, v = A(() => {
...
function _h(e) {
  ...
  const [t, i] = p({
    ...
    var H;
    const { src: M, alt: S, width: L, height: k } = (H = e == null ? void 0 : e.node) == null ? void 0 : H.attrs, B = Ct(L) ? `${L}px` : L, R = Ct(k) ? `${k}px` : k;
    return {
      src: M || void 0,
      alt: S || void 0,
      style: {
  ...
  function C(M, S) {
    ...
    const L = n.width, k = n.height, B = L / k;
  ...
  const T = A(
    Le((M) => {
      if (M.preventDefault(), M.stopPropagation(), !c)
        return;
      const { x: S, w: L, dir: k } = d, B = (M.clientX - S) * (/l/.test(k) ? -1 : 1), R = hn(L + B, hi, t.width);
      e.updateAttributes({
        width: R,
        height: null
      });
...
function Ch({ editor: e, node: t, updateAttributes: i, getPos: n, selected: a }) {
  const [o, c] = p({
    ...
    const { src: L, alt: k, width: B, height: R } = t == null ? void 0 : t.attrs, H = Li(B) ? `${B}px` : B, E = Li(R) ? `${R}px` : R;
    return {
      src: L || void 0,
      alt: k || void 0,
      style: {
  ...
  const N = A(
    Le((L) => {
      if (L.preventDefault(), L.stopPropagation(), !h)
        return;
      const { x: k, w: B, dir: R } = f, H = (L.clientX - k) * (/l/.test(R) ? -1 : 1), E = An(B + H, hi, o.width);
      i({
        width: E,
        height: null
      });
  ...
  const S = D(() => new ResizeObserver(() => _()), [_]);
  return z(() => (S.observe(e.view.dom), () => {
    S.disconnect();
  }), [e.view.dom, S]), /* @__PURE__ */ r(ae, { className: "image-view", style: { ...C, width: "100%", textAlign: x }, children: /* @__PURE__ */ m(
    "div",
    {
      draggable: "true",
      "data-drag-handle": !0,
