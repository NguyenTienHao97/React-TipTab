...
import { u as V, C as po, E as wo, l as j, B as _o, I as Tt, V as Kt, M as vo, D as xn, a as yo, b as ko, c as Ii, d as bn, e as Co, f as Ke, g as Ge, h as ui, T as xt, i as bt, j as pt } from "./locales-C6uDsGRq.js";
...
function ns({ editor: e, disabled: t }) {
  ...
  return console.log("keyboardOffset", a), /* @__PURE__ */ r(
    "div",
    {
      style: {
...
function Rs(e) {
  ...
  function I() {
    ...
    if (o !== -1) {
      ...
      e.editor.chain().command(({ dispatch: K, tr: X, state: Re }) => K ? (H ? X.insertText("/", o, o + 1) : X.insert(
        O,
...
function Vs({ editor: e, disabled: t }) {
  var b, N, C, v, _, k, T, I, R, M, L, S, y, D, O, H, z, K;
...
function Fl(e) {
  ...
  const [t, i] = p({
    ...
    var xe;
    const { src: L, alt: S, width: y, height: D, flipX: O, flipY: H } = (xe = e == null ? void 0 : e.node) == null ? void 0 : xe.attrs, z = Nt(y) ? `${y}px` : y, K = Nt(D) ? `${D}px` : D, X = [];
  ...
  function C(L, S) {
    ...
    const K = t.width;
    H && !z ? (H = H > K ? K : H, z = Math.round(H / O)) : z && !H ? (H = Math.round(z * O), H = H > K ? K : H) : !H && !z ? (H = y > K ? K : y, z = Math.round(H / O)) : H = H > K ? K : H, Xe(() => {
      s(!0), l({
        x: L.clientX,
        y: L.clientY,
        w: H,
