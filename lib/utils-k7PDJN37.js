...
import { u as F, C as xo, E as bo, l as j, B as po, I as Nt, V as Kt, M as wo, D as gn, a as _o, b as vo, c as Si, d as xn, e as yo, f as We, g as Ke, h as hi, T as gt, i as xt, j as bt } from "./locales-B-b67Xbr.js";
...
ie.displayName = bn.Root.displayName;
const se = ot.Root, le = ot.Trigger, re = V.forwardRef(({ className: e, align: t = "center", sideOffset: i = 4, ...n }, a) => /* @__PURE__ */ r(ot.Portal, { children: /* @__PURE__ */ r(
  ot.Content,
  {
    ref: a,
    align: t,
    ...
    ce,
    {
      ...
      children: t != null && t.disabled ? /* @__PURE__ */ r(K, {}) : /* @__PURE__ */ r("div", { className: "richtext-p-2 richtext-bg-white !richtext-border richtext-rounded-lg richtext-shadow-sm dark:richtext-bg-black richtext-border-neutral-200 dark:richtext-border-neutral-800", children: s ? /* @__PURE__ */ m(K, { children: [
        ...
        /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-justify-between richtext-gap-[6px]", children: [
          ...
          /* @__PURE__ */ r("a", { href: "https://katex.org/docs/supported", target: "_blank", rel: "noreferrer noopener", children: /* @__PURE__ */ r(tn, { size: 16 }) })
        ] })
      ] }) : /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-justify-center richtext-gap-[6px]", children: [
        /* @__PURE__ */ r(w, { tooltip: "Edit", action: () => d(!s), children: /* @__PURE__ */ r(nn, { size: 16 }) }),
...
const qo = { padding: "0 12px 12px" }, An = ({ width: e, maxWidth: t, height: i, onOk: n, children: a }) => {
  ...
  return /* @__PURE__ */ m(se, { modal: !0, children: [
    ...
    /* @__PURE__ */ r(re, { children: /* @__PURE__ */ r("div", { style: qo, children: /* @__PURE__ */ m("form", { className: "richtext-flex richtext-flex-col richtext-gap-2", onSubmit: d, children: [
...
function oc({ editor: e, node: t, updateAttributes: i }) {
  ...
  return /* @__PURE__ */ r(ae, { className: ee(tt.wrap, a && tt.isActive), children: /* @__PURE__ */ r(lo, { onChange: v, children: /* @__PURE__ */ r(
    pn,
    {
...
const xc = ({ editor: e }) => {
  ...
  renderHTML({ HTMLAttributes: e, node: t }) {
    return ["div", ne(this.options.HTMLAttributes, e, dc(t))];
  },
  addCommands() {
    return {
...
function Pc({ node: e }) {
  ...
  return i ? /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ r("div", { "data-twitter": "", children: /* @__PURE__ */ r(So, { id: i }) }) }) : null;
}
function Dc(e) {
  function t(i) {
    e.action && e.action(i);
...
function pl(e) {
  ...
  return /* @__PURE__ */ m(se, { modal: !0, open: t, onOpenChange: i, children: [
    ...
    /* @__PURE__ */ r(re, { hideWhenDetached: !0, className: "richtext-w-full", align: "start", side: "bottom", children: /* @__PURE__ */ r(jn, { editor: e.editor, onSetLink: n }) })
  ] });
}
const uu = Fa.extend({
  inclusive: !1,
...
const ku = no.extend({
  ...
  addExtensions() {
    return [
      ...
      oo.configure(this.options.tableCell),
...
function Vd({ editor: e, ...t }) {
  const { t: i } = F(), n = dt(e, Ve.name, {
    text: "",
    defaultShowPicker: !1
  }), { text: a, defaultShowPicker: o } = n, [c, s] = p(""), d = L(() => {
...
function Nh({ editor: e, node: t, updateAttributes: i, getPos: n, selected: a }) {
  ...
  return z(() => (A.observe(e.view.dom), () => {
    A.disconnect();
  }), [e.view.dom, A]), /* @__PURE__ */ r(ae, { className: "image-view", style: { ...y, width: "100%", textAlign: x }, children: /* @__PURE__ */ m(
    "div",
    {
      draggable: "true",
      "data-drag-handle": !0,
