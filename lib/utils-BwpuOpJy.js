...
import { u as V, C as go, E as xo, l as j, B as bo, I as Nt, V as Kt, M as po, D as fn, a as wo, b as _o, c as Si, d as gn, e as vo, f as We, g as Ke, h as hi, T as gt, i as xt, j as bt } from "./locales-JWkN-i2O.js";
...
function ac({ editor: e, node: t, updateAttributes: i }) {
  const n = Y(null), a = e.isActive(De.name), { data: o, width: c, height: s } = t.attrs, [d, l] = p(null), [h, u] = p(!0), [f, g] = p(null), [x, b] = p(!1), [k, T] = p(100), v = A(
    (N) => {
      N && b(!0);
    },
    [b]
...
function Cc({ editor: e }) {
  ...
  const h = A(() => {
    ...
    (k) => {
      e.chain().updateAttributes(Be.name, k).setNodeSelection(e.state.selection.from).focus().run();
    },
    [e]
...
a-->b`, Mc = ({ editor: e, attrs: t, extension: i }) => {
  const { alt: n, align: a } = t, [o, c] = p(decodeURIComponent(n ?? Oi)), [s, d] = p(""), [l, h] = p(!1), u = Y(null), f = i == null ? void 0 : i.options.upload, g = async (k) => {
    try {
      const { svg: T } = await Tt.render("mermaid-svg", k);
      d(T);
    } catch {
      d("");
    }
          ...
          /* @__PURE__ */ r(et, { children: /* @__PURE__ */ r(
            U,
            {
              ...
              onClick: async () => {
                if (o !== "") {
                  if (o) {
                    const k = u.current.querySelector("svg"), { width: T, height: v } = k.getBoundingClientRect(), w = `mermaid-${In()}.svg`;
                    let y = ln(k.outerHTML);
                    if (f) {
                      const N = _i(y, w);
                      y = await f(N);
                    }
...
function Vc({ editor: e, disabled: t, bubbleMenu: i }) {
  const n = e.extensionManager.extensions.map((o) => o.name), a = () => {
    ...
    return [
      ...
      (k = i == null ? void 0 : i.floatingMenuConfig) != null && k.hidden ? null : /* @__PURE__ */ r(Es, { editor: e, disabled: t }, "content"),
...
function En(e) {
  ...
  return /* @__PURE__ */ m(se, { modal: !0, children: [
    ...
    /* @__PURE__ */ r(re, { hideWhenDetached: !0, className: "richtext-w-full richtext-h-full richtext-p-2", align: "start", side: "bottom", children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col", children: [
      ...
      d.map((g, x) => /* @__PURE__ */ r("span", { className: "richtext-relative richtext-flex richtext-w-full richtext-h-auto richtext-p-0 last:richtext-pb-2", children: g.map((b, k) => /* @__PURE__ */ r(
        "span",
        {
  ...
  const { t: i } = V(), { isKeyboardVisible: n } = Qc(), a = D(
    ...
    for (const u of l) {
      ...
      if (Array.isArray(k)) {
        const T = k.map((v, w) => ({
          button: v,
          divider: w === k.length - 1 ? g : !1,
          spacer: w === 0 ? x : !1
        }));
        h = [...h, ...T];
        continue;
      }
      h.push({ button: k, divider: g, spacer: x });
    }
    return h;
  }, [e, i]), c = D(
    () => o.filter(
          ...
          children: [
            ...
            /* @__PURE__ */ m(_e, { open: l, onOpenChange: O, children: [
              ...
              /* @__PURE__ */ m(xe, { className: "richtext-w-48", align: "start", side: "bottom", sideOffset: 0, children: [
                ...
                /* @__PURE__ */ m(de, { className: "richtext-flex richtext-gap-3", onClick: k, children: [
...
function Ps({ editor: e, disabled: t }) {
  var f, g, x, b, k, T, v, w, y, N, I, O, M, S;
      ...
      children: t ? /* @__PURE__ */ r(K, {}) : /* @__PURE__ */ m("div", { style: { width: 300, overflowX: "auto" }, className: "richtext-flex richtext-flex-row richtext-h-full richtext-items-center richtext-leading-none richtext-gap-0.5 richtext-p-2 richtext-bg-background richtext-rounded-lg richtext-shadow-sm !richtext-border richtext-border-border", children: [
        ...
        /* @__PURE__ */ r(
          _,
          {
            ...
            disabled: !((T = e == null ? void 0 : (k = e.can()).deleteColumn) != null && T.call(k))
          }
        ),
...
function Fi({
  ...
  return at(e, (c) => c.type.name === t).forEach((c) => {
    ...
    for (const g of f) {
      for (const x of g) {
        const b = s + x.content.length, k = Ue.inline(s, b, {
          style: `color: ${x.color}`
        });
        a.push(k), s = b;
      }
...
function Dl(e, t) {
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      ref: c,
      children: (k = e == null ? void 0 : e.items) != null && k.length ? /* @__PURE__ */ r("div", { className: "richtext-grid richtext-grid-cols-1 richtext-gap-0.5 richtext-min-w-48", children: (T = e == null ? void 0 : e.items) == null ? void 0 : T.map((v, w) => /* @__PURE__ */ m(st, { children: [
...
function $l(e) {
  ...
  const I = D(() => new ResizeObserver(() => k()), [k]);
...
function Vl({ editor: e, imageInline: t, onClose: i }) {
  ...
  async function k() {
    var w, y;
    try {
      const N = await _i(l, ((w = f == null ? void 0 : f.file) == null ? void 0 : w.name) || "image.png"), I = (y = e.extensionManager.extensions.find(
        (M) => M.name === "image"
    ...
    /* @__PURE__ */ m(He, { open: a, children: [
      ...
      /* @__PURE__ */ m(ye, { children: [
        ...
        /* @__PURE__ */ m(et, { children: [
          ...
          /* @__PURE__ */ m(U, { className: "richtext-w-fit", onClick: k, children: [
...
function Fl(e) {
  ...
  async function d(u) {
    var k, T;
    const f = (k = u == null ? void 0 : u.target) == null ? void 0 : k.files;
    ...
    for (const c of n) {
      ...
      d.setMeta(je, {
        ...
        async (h) => {
          ...
          const k = a.state.tr.replaceWith(f, f, x).setMeta(je, { remove: [s] });
          a.dispatch(k);
        },
        () => {
...
function sd({ editor: e, ...t }) {
  ...
  return z(() => {
    ...
    return window.addEventListener(ni, k), () => {
      b && window.removeEventListener(ni, k);
    };
  }, [u, e]), /* @__PURE__ */ m(
    se,
    {
...
function Gd(e) {
  ...
  async function d(u) {
    ...
    if (ic(e.editor, "image")) {
      const T = (k = e.editor.extensionManager.extensions.find(
        (v) => v.name === "importWord"
...
function wh({ editor: e, node: t, updateAttributes: i, deleteNode: n, extension: a }) {
  var N;
  const o = Y(), c = Pt(), { hasTrigger: s, fileName: d, fileSize: l, fileExt: h, fileType: u, url: f, error: g } = t.attrs, [x, b] = p(!1), { t: k } = V(), T = (N = a == null ? void 0 : a.options) == null ? void 0 : N.upload, v = A(() => {
  ...
  return c && !f ? /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ m("div", { className: ee(Wt.wrap, "render-wrapper"), children: [
    /* @__PURE__ */ r("p", { style: { cursor: "pointer" }, onClick: v, children: x ? /* @__PURE__ */ r("span", { children: k("editor.attachment.uploading") }) : /* @__PURE__ */ r("span", { children: k("editor.attachment.please_upload") }) }),
...
function Ch({ editor: e, node: t, updateAttributes: i, getPos: n, selected: a }) {
  ...
  return z(() => (S.observe(e.view.dom), () => {
    S.disconnect();
  }), [e.view.dom, S]), /* @__PURE__ */ r(ae, { className: "image-view", style: { ...k, width: "100%", textAlign: x }, children: /* @__PURE__ */ m(
    "div",
    {
      draggable: "true",
      "data-drag-handle": !0,
