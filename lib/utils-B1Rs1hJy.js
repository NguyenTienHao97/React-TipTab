...
import { u as F, C as po, E as wo, l as V, B as _o, I as Tt, V as Gt, M as vo, D as xn, a as yo, b as ko, c as Ii, d as bn, e as Co, f as Ge, g as Ke, h as ui, T as xt, i as bt, j as pt } from "./locales-BLCM8245.js";
...
const ve = K.Root, ye = K.Trigger, zi = K.Portal, Hi = K.Sub, Zt = $.forwardRef(({ className: e, inset: t, children: i, ...n }, a) => /* @__PURE__ */ m(
  K.SubTrigger,
  {
    ref: a,
    className: P(
...
const jo = ht.Provider, et = ht.Root, tt = ht.Trigger, He = $.forwardRef(({ className: e, sideOffset: t = 4, ...i }, n) => /* @__PURE__ */ r(
  ht.Content,
  {
    ref: n,
    sideOffset: t,
...
const Vo = Z.Root, Uo = Z.Value, kn = $.forwardRef(({ className: e, children: t, ...i }, n) => /* @__PURE__ */ m(
  Z.Trigger,
  {
    ref: n,
    className: P(
...
function Go({ editor: e, ...t }) {
  const i = ut(e, je.name, {
    text: "",
    defaultShowPicker: !1
  }), { text: n, defaultShowPicker: a } = i, [o, c] = w(""), [s, d] = w(!1), l = A(() => e.isActive(je.name), [e]), h = A(() => Qe(je.name, e), [e]), u = A(() => {
    e.chain().focus().setKatex({ text: o }).run(), d(!1);
  }, [e, o]);
  E(() => {
    a && (d(!0), e.chain().updateAttributes(je.name, { defaultShowPicker: !1 }).focus().run());
  }, [e, a, d]), E(() => {
    s && c(n || "");
  }, [s]);
  const f = B(() => {
  ...
  return /* @__PURE__ */ r(
    ce,
    {
      ...
      children: t != null && t.disabled ? /* @__PURE__ */ r(q, {}) : /* @__PURE__ */ r("div", { className: "richtext-p-2 richtext-bg-white !richtext-border richtext-rounded-lg richtext-shadow-sm dark:richtext-bg-black richtext-border-neutral-200 dark:richtext-border-neutral-800", children: s ? /* @__PURE__ */ m(q, { children: [
        ...
        /* @__PURE__ */ r(p, { tooltip: "Edit", action: () => d(!s), children: /* @__PURE__ */ r(rn, { size: 16 }) }),
...
function sc({ editor: e, node: t, updateAttributes: i }) {
  const n = J(null), a = e.isActive(De.name), { data: o, width: c, height: s } = t.attrs, [d, l] = w(null), [h, u] = w(!0), [f, g] = w(null), [x, b] = w(!1), [C, T] = w(100), v = A(
    (N) => {
      N && b(!0);
    },
    [b]
...
const lc = Ve.memo(sc, (e, t) => !!li(e.node.attrs, t.node.attrs));
function dc(e, t = "{}") {
  try {
...
const pc = ({ editor: e }) => {
  const [t, i] = w(null), [n, a] = w({}), [o, c] = w({ elements: [], appState: { isLoading: !1 }, files: null }), [s, d] = w(!1), [l, h] = w(!0), [u, f] = w(null), g = A(
    (T) => {
...
function Tc({ editor: e, node: t, updateAttributes: i }) {
  const n = Bt(), { url: a, width: o, height: c } = t.attrs, [s, d] = w("");
  function l() {
...
a-->b`, Hc = ({ editor: e, attrs: t, extension: i }) => {
  const { alt: n, align: a } = t, [o, c] = w(decodeURIComponent(n ?? Bi)), [s, d] = w(""), [l, h] = w(!1), u = J(null), f = i == null ? void 0 : i.options.upload, g = async (C) => {
    try {
          ...
          /* @__PURE__ */ r(it, { children: /* @__PURE__ */ r(
            U,
            {
              ...
              onClick: async () => {
                if (o !== "") {
                  if (o) {
                    const C = u.current.querySelector("svg"), { width: T, height: v } = C.getBoundingClientRect(), _ = `mermaid-${Hn()}.svg`;
...
const Fc = /(https?:\/\/)?(www\.)?x\.com\/(\w{1,15})(\/status\/(\d+))?(\/\S*)?/g, jc = /^https?:\/\/(www\.)?x\.com\/(\w{1,15})(\/status\/(\d+))?(\/\S*)?$/;
function Di(e) {
  return e.match(jc);
}
const ti = ue.create({
...
function Vc({ editor: e, disabled: t }) {
  const [i, n] = w(!1), { t: a } = F(), o = A(({ editor: d }) => d.isActive(ti.name), []), c = (d) => {
...
function Uc({ editor: e, disabled: t, bubbleMenu: i }) {
  const n = e.extensionManager.extensions.map((o) => o.name), a = () => {
    ...
    return [
      n.includes("columns") && !((o = i == null ? void 0 : i.columnConfig) != null && o.hidden) ? /* @__PURE__ */ r(Xs, { editor: e }, "columns") : null,
      n.includes("table") && !((c = i == null ? void 0 : i.tableConfig) != null && c.hidden) ? /* @__PURE__ */ r($s, { editor: e }, "table") : null,
      n.includes("link") && !((s = i == null ? void 0 : i.linkConfig) != null && s.hidden) ? /* @__PURE__ */ r(js, { editor: e, disabled: t }, "link") : null,
      n.includes("image") && !((d = i == null ? void 0 : i.imageConfig) != null && d.hidden) ? /* @__PURE__ */ r(qs, { editor: e, disabled: t }, "image") : null,
      ...
      (C = i == null ? void 0 : i.floatingMenuConfig) != null && C.hidden ? null : /* @__PURE__ */ r(Rs, { editor: e, disabled: t }, "content"),
      (T = i == null ? void 0 : i.textConfig) != null && T.hidden ? null : /* @__PURE__ */ r(Bs, { editor: e, disabled: t }, "text")
    ];
  };
...
function Wc({ setColor: e }) {
  const [t, i] = w("#000000"), [n, a] = w(!1), { t: o } = F();
  return E(() => () => {
    a(!1);
...
}, Fi = "data-rc-order", ji = "data-rc-priority", Xc = "rc-util-key", ii = /* @__PURE__ */ new Map();
function Zc(e, t) {
  if (!e)
    return !1;
  if (e.contains)
...
function Dn(e, t = {}) {
  ...
  s.setAttribute(Fi, o), c && a && s.setAttribute(ji, `${a}`), i != null && i.nonce && (s.nonce = i == null ? void 0 : i.nonce), s.innerHTML = e;
    ...
    if (c) {
      const h = Bn(d).filter((u) => {
        if (!["prepend", "prependQueue"].includes(u.getAttribute(Fi)))
          return !1;
        const f = Number(u.getAttribute(ji) || 0);
        return a >= f;
      });
      if (h.length > 0)
...
function ts(e, t) {
  ...
  }, []), s ? /* @__PURE__ */ r("div", { className: "reactjs-tiptap-editor", children: /* @__PURE__ */ r(jo, { delayDuration: 0, disableHoverableContent: !0, children: /* @__PURE__ */ m("div", { className: "richtext-overflow-hidden", children: [
    /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-max-h-full", children: [
      /* @__PURE__ */ r(ya, { className: `richtext-relative ${(e == null ? void 0 : e.contentClass) || ""}`, editor: s }),
      !(e != null && e.hideBubble) && /* @__PURE__ */ r(Uc, { bubbleMenu: e == null ? void 0 : e.bubbleMenu, editor: s, disabled: e == null ? void 0 : e.disabled })
    ] }),
    !(e != null && e.hideToolbar) && /* @__PURE__ */ r(is, { editor: s, disabled: !!(e != null && e.disabled) })
  ] }) }) }) : /* @__PURE__ */ r(q, {});
}
const Zh = Lt(ts);
function is({ editor: e, disabled: t }) {
  const { t: i, lang: n } = F(), a = B(() => {
...
function Rs(e) {
  var M, L, S;
  const { pluginKey: t = Na } = e, { t: i } = F(), [n, a] = w(null), [o, c] = w(-1), s = J(null), d = J(null), [l, h] = w(!1), u = e.editor.extensionManager.extensions.some((y) => y.name === "textAlign"), f = e.editor.extensionManager.extensions.some((y) => y.name === "indent"), g = e.editor.extensionManager.extensions.some((y) => y.name === "clear");
  E(() => {
...
function Ps({ item: e, disabled: t, editor: i }) {
  var a;
  const n = e.component;
  return n ? /* @__PURE__ */ r(
    n,
  ...
  return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-h-[32px]", children: [
    /* @__PURE__ */ r(
      p,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "richtext-flex richtext-items-center richtext-justify-center richtext-text-sm", children: /* @__PURE__ */ r(Ds, { fill: t }) })
      }
    ),
    /* @__PURE__ */ r(
      Rn,
...
function $s({ editor: e, disabled: t }) {
  var b, C, T, v, _, k, N, I, O, M, L, S, y, D, R, H, z, G;
      ...
      children: t ? /* @__PURE__ */ r(q, {}) : /* @__PURE__ */ m("div", { className: "richtext-min-w-32 richtext-flex richtext-flex-row richtext-h-full richtext-items-center richtext-leading-none richtext-gap-0.5 richtext-p-2 richtext-w-full richtext-bg-background richtext-rounded-lg richtext-shadow-sm !richtext-border richtext-border-border", children: [
        ...
        /* @__PURE__ */ r(
          p,
          {
            ...
            disabled: !((G = (z = e == null ? void 0 : e.can()) == null ? void 0 : z.deleteTable) != null && G.call(z))
          }
        )
      ] })
    }
...
function qs(e) {
  ...
  }, n = B(() => e.disabled ? [] : Ls(e.editor), [e.disabled, e.editor, t]);
  return /* @__PURE__ */ r(q, { children: /* @__PURE__ */ r(
    ce,
    {
      shouldShow: i,
...
function Ks(e) {
  ...
  }, n = B(() => e.disabled ? [] : Is(e.editor), [e.editor, e.disabled, t]);
  return /* @__PURE__ */ r(q, { children: /* @__PURE__ */ r(
    ce,
    {
      shouldShow: i,
...
let fe, rt;
const jt = /* @__PURE__ */ new Set(), Vt = /* @__PURE__ */ new Set();
function Zs() {
  return fe;
}
function Ys(e) {
...
async function qn(e) {
  return fe && !fe.getLoadedThemes().includes(e) && !Vt.has(e) && e in fn ? (Vt.add(e), await fe.loadTheme(e), Vt.delete(e), !0) : !1;
}
async function Gn(e) {
    ...
    view(a) {
      class o {
        ...
        async initDecorations() {
          const s = a.state.doc;
          await Js({ doc: s, name: e, defaultLanguage: t, defaultTheme: i });
...
function el({ action: e, languages: t, ...i }) {
  const n = (o) => {
    e(o);
...
const tl = "_wrap_134f4_1", il = "_maxHeight_134f4_10", nl = "_btnCopy_134f4_13", rl = "_btnDelete_134f4_14", al = "_blockInfo_134f4_18", ol = "_blockInfoEditable_134f4_28", cl = "_selectLang_134f4_32", sl = "_copied_134f4_58", pe = {
  wrap: tl,
  maxHeight: il,
  btnCopy: nl,
  btnDelete: rl,
  blockInfo: al,
  blockInfoEditable: ol,
  selectLang: cl,
...
function dl({ editor: e, node: { attrs: t }, updateAttributes: i, extension: n }) {
  var f, g;
  const { isCopied: a, copyToClipboard: o } = ll(), c = B(() => {
    var x;
    return (x = n.options.languages) != null && x.length ? n.options.languages : xn;
  }, [n.options.languages]), s = Bt(), d = (g = (f = e == null ? void 0 : e.options) == null ? void 0 : f.editorProps) == null ? void 0 : g.print, { language: l } = t, h = J(), u = A(() => Qe(hl.name, e), [e]);
...
function bl(e) {
  ...
  return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-h-[32px]", children: [
    /* @__PURE__ */ r(p, { tooltip: e == null ? void 0 : e.tooltip, disabled: e == null ? void 0 : e.disabled, action: a, children: /* @__PURE__ */ r("span", { className: "richtext-flex richtext-items-center richtext-justify-center richtext-text-sm", children: /* @__PURE__ */ r(xl, { fill: t }) }) }),
    /* @__PURE__ */ r(
      Rn,
      {
        selectedColor: t,
...
const ou = Pa.extend({
  ...
  addExtensions() {
    return [ja.configure(this.options.taskItem)];
  }
}), uu = Va.extend({
  addOptions() {
    var e;
...
const _l = ["undo", "redo"], gu = Ga.extend({
  addOptions() {
    var e;
    return {
      ...(e = this.parent) == null ? void 0 : e.call(this),
    ...
    return this.options.document !== !1 && e.push(vl.configure()), this.options.placeholder !== !1 && e.push(
      Xa.configure({
        placeholder: ({ node: t, pos: i, editor: n }) => {
          var a, o, c, s, d;
          return ((a = t == null ? void 0 : t.type) == null ? void 0 : a.name) === "columns" || ((o = t == null ? void 0 : t.content) == null ? void 0 : o.size) !== 0 ? "" : ((c = t == null ? void 0 : t.type) == null ? void 0 : c.name) === "heading" ? `${V.t(`editor.heading.h${t.attrs.level}.tooltip`)}` : ((s = t == null ? void 0 : t.type) == null ? void 0 : s.name) === "codeBlock" || ((d = t == null ? void 0 : t.type) == null ? void 0 : d.name) === "table" ? "" : n.extensionManager.extensions.some((l) => l.name === "slashCommand") ? V.t("editor.slash") : i === 0 ? V.t("editor.content") : V.t("editor.content");
        },
...
function Bl(e) {
  ...
  return e.forEach((i) => {
    i.name.toLowerCase() === "heading" && i.options.levels.forEach((n) => {
      ...
      name: "codeBlock",
      label: V.t("editor.codeblock.tooltip"),
      iconName: "Code2",
...
function Dl(e, t) {
  var C, T;
  const [i, n] = w(0), [a, o] = w(0), c = J(null), { t: s } = F(), d = J([]);
  St(t, () => ({
    onKeyDown: l
  })), E(() => {
    if (!c.current)
  ...
  addProseMirrorPlugins() {
    return [
      dn({
        ...
        items: ({ query: e, editor: t }) => Bl(t.extensionManager.extensions).map((c) => ({
          ...c,
...
function Fl(e) {
  ...
  const [t, i] = w({
    ...
    var xe;
    const { src: L, alt: S, width: y, height: D, flipX: R, flipY: H } = (xe = e == null ? void 0 : e.node) == null ? void 0 : xe.attrs, z = Nt(y) ? `${y}px` : y, G = Nt(D) ? `${D}px` : D, X = [];
...
function jl({ editor: e, imageInline: t, onClose: i }) {
  const { t: n } = F(), [a, o] = w(!1), c = Ve.useRef(null), [s, d] = Ve.useState(), [l, h] = Ve.useState(""), u = J(null), [f, g] = w({
    src: "",
    file: null
  });
  function x(_) {
...
function Vl(e) {
  const { t } = F(), i = Ol(), [n, a] = w(""), o = J(null), [c, s] = w(!1);
  async function d(u) {
    var C, T;
      ...
      apply(e, t) {
        ...
        if (i != null && i.add)
          for (const { id: n, pos: a, src: o } of i.add) {
            const c = Wl(o), s = qe.widget(a, c, { id: n });
            t = t.add(e.doc, [s]);
          }
...
const Zl = {
  ...
  addProseMirrorPlugins() {
    ...
    return [
      new we({
        props: {
          handlePaste: (i, n) => !n.clipboardData || [...n.clipboardData.files || []].some((o) => o.type === "text/html") ? !1 : Kl(i, n, t),
...
function Jl(e) {
  const { t } = F(), [i, n] = w(""), a = J(null), o = Pl(), [c, s] = w("");
  async function d(u) {
    var C, T;
    const f = (C = u == null ? void 0 : u.target) == null ? void 0 : C.files;
    if (!e.editor || e.editor.isDestroyed || f.length === 0)
...
function ld({ editor: e, ...t }) {
  const { t: i } = F(), [n, a] = w(-1), [o, c] = w([]), [s, d] = w(""), [l, h] = w(""), [u, f] = w(!1), [g, x] = w(!1);
  return E(() => {
    ...
    if (!e)
      return;
    const b = e.extensionManager.extensions.find((T) => T.name === fd.name);
    if (!b)
      return;
    const C = () => {
      if (!u)
...
const ri = "ON_SEARCH_RESULTS", Pe = new CustomEvent(ri), fd = Y.create({
  name: "search",
  addOptions() {
    var e;
    return {
  ...
  addCommands() {
    return {
      ...
      replaceAll: () => ({ state: e, tr: t, dispatch: i }) => {
        ...
        return md(n, a, { tr: t, dispatch: i }), this.storage.currentIndex = -1, this.storage.results = [], window.dispatchEvent(Pe), at(e, i), !1;
      },
...
const gd = Object.keys(Je).map((e) => e);
...
const Be = Rd("EMOJI_PICKER", 20), Ji = [
  {
...
const Dd = 200, $d = new _e("emoji"), Tu = ue.create({
  name: "emoji",
  content: "text*",
  priority: Dd,
  addOptions() {
...
function Fd({ editor: e, ...t }) {
  const { t: i } = F(), n = ut(e, je.name, {
    text: "",
    defaultShowPicker: !1
  }), { text: a, defaultShowPicker: o } = n, [c, s] = w(""), d = A(() => {
  ...
  async function d(u) {
    ...
    if (ac(e.editor, "image")) {
      ...
      if (T && typeof T.upload == "function") {
        const v = [];
        for (const k of x) {
          const N = k.getAttribute("src"), I = Gd(N, "image/jpeg"), O = Kd(I, "image.jpeg");
          v.push(O);
        }
  ...
  addCommands() {
    return {
      exportToWord: () => async ({ editor: e }) => {
        ...
        return So.toBlob(i).then((n) => Yd(new Blob([n]), "export-document.docx")), !0;
      }
    };
  }
}), eh = "_toc_aag8a_1", th = "_visible_aag8a_7", ih = "_list_aag8a_11", nh = "_item_aag8a_16", _t = {
  toc: eh,
  visible: th,
  list: ih,
  item: nh,
...
}), uh = "_listUsers_en3pm_1", mh = "_itemUser_en3pm_10", fh = "_selectedUser_en3pm_31", vt = {
  listUsers: uh,
  itemUser: mh,
  selectedUser: fh
}, gh = Lt((e, t) => {
  const i = J(), [n, a] = w(0), o = (l) => {
    const h = e.items[l];
...
const wh = "_wrap_gpqtf_1", qt = {
  wrap: wh
};
function _h({ editor: e, node: t, updateAttributes: i, deleteNode: n, extension: a }) {
  var N;
  const o = J(), c = Bt(), { hasTrigger: s, fileName: d, fileSize: l, fileExt: h, fileType: u, url: f, error: g } = t.attrs, [x, b] = w(!1), { t: C } = F(), T = (N = a == null ? void 0 : a.options) == null ? void 0 : N.upload, v = A(() => {
...
function yh({ selectImage: e, giphyApiKey: t, children: i }) {
  const [n, a] = w([]), [o] = w(15), c = J(null), s = (l, h = "search") => {
    if (!t)
      return;
...
a-->b`, Ch = ({ editor: e, upload: t }) => {
  const [i, n] = w(Qi), [a, o] = w(""), [c, s] = w(!1), d = J(null), l = async (f) => {
    try {
...
function Nh({ editor: e, node: t, updateAttributes: i, getPos: n, selected: a }) {
  ...
  function k(S, y) {
    ...
    const X = o.width;
    z && !G ? (z = z > X ? X : z, G = Math.round(z / H)) : G && !z ? (z = Math.round(G * H), z = z > X ? X : z) : !z && !G ? (z = D > X ? X : D, G = Math.round(z / H)) : z = z > X ? X : z, Xe(() => {
      u(!0), g({
        x: S.clientX,
        y: S.clientY,
        w: z,
